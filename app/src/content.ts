...
export const VOCAB_TOPICS: VocabTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Afternoon', id: 'Siang', emoji: '☀️', example: { en: 'I take a nap in the afternoon.', id: 'Aku tidur siang.', emoji: '☀️' } },
      ...
      { en: 'Week', id: 'Seminggu', emoji: '🗓️', example: { en: 'A week has seven days.', id: 'Seminggu ada tujuh hari.', emoji: '🗓️' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Candle', id: 'Lilin', emoji: '🕯️', example: { en: 'I blow out the candle.', id: 'Aku meniup lilinnya.', emoji: '🕯️' } },
...
export const LISTENING_TOPICS: ListeningTopic[] = [
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Roti',
        emoji: '🍞',
        example: { en: 'What do you want, Bayu? I want some bread, please.', id: 'Kamu mau apa, Bayu? Aku mau roti, ya.', emoji: '🍞' },
        question: {
          en: 'What does Bayu want at the shop?',
          id: 'Bayu mau apa di toko?',
          options: [
            { emoji: '🍞', text: 'Bread', ok: true },
            { emoji: '🍰', text: 'Cake', ok: false },
            { emoji: '🥛', text: 'Milk', ok: false },
            { emoji: '🧀', text: 'Cheese', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Keranjang',
        emoji: '🧺',
        example: { en: 'Can I use a basket? Yes, here you are, Lia.', id: 'Boleh aku pakai keranjang? Boleh, ini dia, Lia.', emoji: '🧺' },
        question: {
          en: 'What does Lia need for shopping?',
          id: 'Lia butuh apa untuk belanja?',
          options: [
            { emoji: '🧺', text: 'Basket', ok: true },
            { emoji: '👜', text: 'Bag', ok: false },
            { emoji: '📦', text: 'Box', ok: false },
            { emoji: '🛒', text: 'Cart', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          id: 'Berapa harga jusnya?',
          options: [
            { emoji: '', text: 'Five Thousand', ok: true },
            { emoji: '', text: 'Two Thousand', ok: false },
            { emoji: '', text: 'Nine Thousand', ok: false },
            { emoji: '', text: 'Ten Thousand', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          id: 'Bayu mau berapa jeruk?',
          options: [
            { emoji: '3️⃣', text: 'Three', ok: true },
            { emoji: '2️⃣', text: 'Two', ok: false },
            { emoji: '4️⃣', text: 'Four', ok: false },
      ...
      },
      {
        ...
        id: 'Tas Kecil',
        emoji: '👜',
        example: { en: 'Do you want the big bag or the small bag? The small bag, please.', id: 'Kamu mau tas besar atau tas kecil? Tas kecil, ya.', emoji: '👜' },
        question: {
          en: 'Which bag does the shopper choose?',
          id: 'Tas mana yang dipilih pembeli itu?',
          options: [
            { emoji: '', text: 'Small Bag', ok: true },
            { emoji: '', text: 'Big Bag', ok: false },
            { emoji: '', text: 'Red Bag', ok: false },
            { emoji: '', text: 'Paper Bag', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Delapan',
        emoji: '🕗',
        example: { en: 'When does the shop open? It opens at eight o’clock.', id: 'Tokonya buka jam berapa? Buka jam delapan.', emoji: '🏪' },
        question: {
          en: 'What time does the shop open?',
          id: 'Tokonya buka jam berapa?',
          options: [
            { emoji: '🕗', text: 'Eight', ok: true },
            { emoji: '🕖', text: 'Seven', ok: false },
            { emoji: '🕘', text: 'Nine', ok: false },
      ...
      },
      {
        ...
        id: 'Air',
        emoji: '💧',
        example: { en: 'Lia is thirsty. She wants to buy a bottle of water.', id: 'Lia haus. Dia mau beli sebotol air.', emoji: '💧' },
        question: {
          en: 'What drink does Lia want to buy?',
          id: 'Minuman apa yang mau dibeli Lia?',
          options: [
      ...
      },
      {
        ...
        question: {
          ...
          options: [
            ...
            { emoji: '🥭', text: 'Mango', ok: false },
            { emoji: '🥥', text: 'Coconut', ok: false },
          ],
        },
      },
    ],
  ...
  {
    id: 'perkenalan',
    title: 'Perkenalan (Getting to Know You)',
    scene: '👋',
    desc: 'Cerita kenalan',
    drill: [
      { en: 'My new friend has a pet cat.', id: 'Teman baruku punya kucing peliharaan.', opts: [{ emoji: '🐱', ok: true }, { emoji: '🐶' }] },
      { en: 'She is nine years old.', id: 'Dia berumur sembilan tahun.', opts: [{ emoji: '9️⃣', ok: true }, { emoji: '6️⃣' }] },
    ],
    // Dialog 2 suara (Lala wanita, Bima pria). Distraktor halus lewat
    // penyangkalan ("No, not football") — anak wajib proses "not" dulu,
    // bukan cuma menangkap nama olahraga pertama yang kedengaran.
    story: ['Hi! I am Lala. What is your name?', 'I am Bima. Do you like football, Lala?', 'No, not football. I like badminton.'],
    storyVoices: ['female', 'male', 'female'],
    question: { en: 'Which sport does Lala like?', id: 'Olahraga apa yang disukai Lala?', opts: [{ emoji: '🏸', lbl: 'Badminton', ok: true }, { emoji: '⚽', lbl: 'Football' }, { emoji: '🏀', lbl: 'Basketball' }], decoys: [{ emoji: '🎾', lbl: 'Tennis' }, { emoji: '🏐', lbl: 'Volleyball' }] },
    kenalanGame: [
      {
        en: 'His Name',
        id: 'Namanya',
        ...
        question: {
          ...
          options: [
            ...
            { emoji: '🏫', text: 'His Class', ok: false },
            { emoji: '🐰', text: 'His Pet', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Delapan',
        emoji: '🎂',
        example: { en: 'How old are you, Rafi? I am eight years old.', id: 'Umurmu berapa, Rafi? Umurku delapan tahun.', emoji: '🎂' },
        question: {
          en: 'How old is Rafi?',
          id: 'Berapa umur Rafi?',
          options: [
            { emoji: '8️⃣', text: 'Eight', ok: true },
            { emoji: '7️⃣', text: 'Seven', ok: false },
            { emoji: '9️⃣', text: 'Nine', ok: false },
            { emoji: '🔟', text: 'Ten', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Bandung',
        emoji: '🏙️',
        example: { en: 'Where do you live, Rafi? I live in Bandung.', id: 'Kamu tinggal di mana, Rafi? Aku tinggal di Bandung.', emoji: '🏙️' },
        question: {
          en: 'Which city is Rafi’s home?',
          id: 'Kota mana yang jadi tempat tinggal Rafi?',
          options: [
            { emoji: '', text: 'Bandung', ok: true },
            { emoji: '', text: 'Jakarta', ok: false },
            { emoji: '', text: 'Surabaya', ok: false },
            { emoji: '', text: 'Medan', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Adik Perempuan',
        emoji: '👧',
        example: { en: 'Do you have a brother or a sister, Rafi? I have a little sister.', id: 'Kamu punya saudara laki-laki atau perempuan, Rafi? Aku punya adik perempuan.', emoji: '👧' },
        question: {
          en: 'Which family member does Rafi talk about?',
          id: 'Anggota keluarga mana yang Rafi ceritakan?',
          options: [
            { emoji: '👧', text: 'Little Sister', ok: true },
            { emoji: '👦', text: 'Big Brother', ok: false },
            { emoji: '👶', text: 'Baby Brother', ok: false },
      ...
      },
      {
        ...
        id: 'Menggambar',
        emoji: '🖍️',
        example: { en: 'What is your hobby, Rafi? I like drawing pictures.', id: 'Apa hobimu, Rafi? Aku suka menggambar.', emoji: '🖍️' },
        question: {
          en: 'What is Rafi’s hobby?',
          id: 'Apa hobi Rafi?',
          options: [
      ...
      },
      {
        ...
        id: 'Matematika',
        emoji: '➗',
        example: { en: 'What is your favorite subject, Rafi? I love math.', id: 'Pelajaran favoritmu apa, Rafi? Aku suka sekali matematika.', emoji: '➗' },
        question: {
          en: 'Which lesson does Rafi love most?',
          id: 'Pelajaran apa yang paling Rafi suka?',
          options: [
            { emoji: '➗', text: 'Math', ok: true },
            { emoji: '🎨', text: 'Art', ok: false },
            { emoji: '🎵', text: 'Music', ok: false },
            { emoji: '🔬', text: 'Science', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kelinci',
        emoji: '🐰',
        example: { en: 'Do you have a pet, Rafi? Yes, I have a white rabbit.', id: 'Kamu punya hewan peliharaan, Rafi? Iya, aku punya kelinci putih.', emoji: '🐰' },
        question: {
          en: 'What animal does Rafi keep at home?',
          id: 'Hewan apa yang Rafi pelihara di rumah?',
          options: [
            { emoji: '🐰', text: 'Rabbit', ok: true },
            { emoji: '🐱', text: 'Cat', ok: false },
            { emoji: '🐶', text: 'Dog', ok: false },
            { emoji: '🐹', text: 'Hamster', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Nasi Goreng',
        emoji: '🍛',
        example: { en: 'What food do you like, Rafi? I like fried rice.', id: 'Kamu suka makanan apa, Rafi? Aku suka nasi goreng.', emoji: '🍛' },
        question: {
          en: 'What is Rafi’s favorite food?',
          id: 'Apa makanan favorit Rafi?',
          options: [
            { emoji: '🍛', text: 'Fried Rice', ok: true },
            { emoji: '🍜', text: 'Noodles', ok: false },
            { emoji: '🍢', text: 'Satay', ok: false },
      ...
      },
      {
        ...
        id: 'Mei',
        emoji: '📅',
        example: { en: 'When is your birthday, Rafi? It is in May.', id: 'Kapan ulang tahunmu, Rafi? Bulan Mei.', emoji: '📅' },
        question: {
          en: 'In which month is Rafi’s birthday?',
          id: 'Ulang tahun Rafi di bulan apa?',
          options: [
            { emoji: '', text: 'May', ok: true },
            { emoji: '', text: 'June', ok: false },
            { emoji: '', text: 'July', ok: false },
            { emoji: '', text: 'March', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Bermain',
        emoji: '🎲',
        example: { en: 'Do you want to play with me, Rafi? Yes, let’s play together!', id: 'Kamu mau main denganku, Rafi? Iya, ayo main bareng!', emoji: '🎲' },
        question: {
          en: 'What do the new friends do next?',
          id: 'Apa yang dilakukan teman baru itu selanjutnya?',
          options: [
            { emoji: '🎲', text: 'Play', ok: true },
            { emoji: '😴', text: 'Sleep', ok: false },
            { emoji: '📚', text: 'Study', ok: false },
  ...
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Penggaris',
        emoji: '📏',
        example: { en: 'Can I borrow your ruler, Dimas? Sure, here you are, Sari.', id: 'Boleh aku pinjam penggarismu, Dimas? Boleh, ini dia, Sari.', emoji: '📏' },
        question: {
          en: 'What does Sari borrow?',
          id: 'Apa yang dipinjam Sari?',
          options: [
            { emoji: '📏', text: 'Ruler', ok: true },
            { emoji: '✂️', text: 'Scissors', ok: false },
            { emoji: '📕', text: 'Book', ok: false },
            { emoji: '🖍️', text: 'Crayon', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Guru',
        emoji: '🧑‍🏫',
        example: { en: 'Who is that? That is our new teacher.', id: 'Itu siapa? Itu guru baru kami.', emoji: '🧑‍🏫' },
        question: {
          en: 'Who is the new person at school?',
          id: 'Siapa orang baru di sekolah?',
          options: [
            { emoji: '🧑‍🏫', text: 'Teacher', ok: true },
            { emoji: '🧑‍⚕️', text: 'Doctor', ok: false },
      ...
      },
      {
        ...
        id: 'Perpustakaan',
        emoji: '📚',
        example: { en: 'Where are you going, Dimas? I am going to the library.', id: 'Kamu mau ke mana, Dimas? Aku mau ke perpustakaan.', emoji: '📚' },
        question: {
          en: 'Where is Dimas going now?',
          id: 'Dimas mau ke mana sekarang?',
          options: [
            { emoji: '📚', text: 'Library', ok: true },
            { emoji: '🍽️', text: 'Canteen', ok: false },
            { emoji: '🌳', text: 'Garden', ok: false },
            { emoji: '🚻', text: 'Toilet', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Sepuluh',
        emoji: '🕙',
        example: { en: 'What time is break time? It is at ten o’clock.', id: 'Jam berapa waktu istirahat? Jam sepuluh.', emoji: '🕙' },
        question: {
          en: 'When is break time?',
          id: 'Kapan waktu istirahat?',
          options: [
            { emoji: '🕙', text: 'Ten', ok: true },
            { emoji: '🕘', text: 'Nine', ok: false },
            { emoji: '🕚', text: 'Eleven', ok: false },
            { emoji: '🕛', text: 'Twelve', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          id: 'Dimas punya berapa buku?',
          options: [
            { emoji: '4️⃣', text: 'Four', ok: true },
            { emoji: '3️⃣', text: 'Three', ok: false },
            { emoji: '5️⃣', text: 'Five', ok: false },
            { emoji: '6️⃣', text: 'Six', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Matematika',
        emoji: '➗',
        example: { en: 'Do you have homework today, Dimas? Yes, I have math homework.', id: 'Kamu ada PR hari ini, Dimas? Iya, aku ada PR matematika.', emoji: '➗' },
        question: {
          en: 'What homework does Dimas have?',
          id: 'Dimas punya PR apa?',
          options: [
            { emoji: '➗', text: 'Math', ok: true },
      ...
      },
      {
        ...
        id: 'Peta',
        emoji: '🗺️',
        example: { en: 'What is on the wall? There is a big map.', id: 'Ada apa di dinding? Ada peta besar.', emoji: '🗺️' },
        question: {
          en: 'What hangs on the classroom wall?',
          id: 'Apa yang tergantung di dinding kelas?',
          options: [
            { emoji: '🗺️', text: 'Map', ok: true },
            { emoji: '🕰️', text: 'Clock', ok: false },
            { emoji: '🖼️', text: 'Picture', ok: false },
            { emoji: '🚩', text: 'Flag', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dekat Jendela',
        emoji: '🪟',
        example: { en: 'Where is my seat? Your seat is near the window, Sari.', id: 'Tempat dudukku di mana? Tempat dudukmu dekat jendela, Sari.', emoji: '🪟' },
        question: {
          en: 'Where is Sari’s seat?',
          id: 'Di mana tempat duduk Sari?',
          options: [
            { emoji: '', text: 'Near the Window', ok: true },
            { emoji: '', text: 'Near the Door', ok: false },
            { emoji: '', text: 'At the Back', ok: false },
            { emoji: '', text: 'At the Front', ok: false },
          ],
        },
      },
      {
   ...
   */
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Gigi',
        emoji: '🦷',
        example: { en: 'What is wrong with your tooth, Tono? It hurts a lot.', id: 'Gigimu kenapa, Tono? Sakit sekali.', emoji: '🦷' },
        question: {
          en: 'Which part of Tono hurts?',
          id: 'Bagian mana dari Tono yang sakit?',
          options: [
            { emoji: '🦷', text: 'Tooth', ok: true },
            { emoji: '👂', text: 'Ear', ok: false },
            { emoji: '👁️', text: 'Eye', ok: false },
            { emoji: '🦵', text: 'Knee', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dokter',
        emoji: '🧑‍⚕️',
        example: { en: 'Who is that in the white coat? That is the doctor.', id: 'Siapa yang pakai jas putih itu? Itu dokternya.', emoji: '🧑‍⚕️' },
        question: {
          en: 'Who wears the white coat?',
          id: 'Siapa yang memakai jas putih?',
          options: [
            { emoji: '🧑‍⚕️', text: 'Doctor', ok: true },
            { emoji: '🧑‍🏫', text: 'Teacher', ok: false },
            { emoji: '🧑‍🍳', text: 'Chef', ok: false },
            { emoji: '🧑‍🌾', text: 'Farmer', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dua',
        emoji: '2️⃣',
        example: { en: 'Is the nurse here? Yes, she is in room two.', id: 'Perawatnya ada? Ada, dia di ruang dua.', emoji: '🚪' },
        question: {
          en: 'Which room is the nurse in?',
          id: 'Perawat ada di ruang berapa?',
          options: [
      ...
      },
      {
        ...
        id: 'Setelah Sarapan',
        emoji: '💊',
        example: { en: 'When do I take the medicine? Take it after breakfast, Sari.', id: 'Kapan aku minum obatnya? Minum setelah sarapan, Sari.', emoji: '💊' },
        question: {
          en: 'When should Sari take the medicine?',
          id: 'Kapan Sari harus minum obat?',
          options: [
            { emoji: '🍳', text: 'After Breakfast', ok: true },
            { emoji: '🍱', text: 'After Lunch', ok: false },
            { emoji: '🍽️', text: 'After Dinner', ok: false },
            { emoji: '🛏️', text: 'Before Bed', ok: false },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        id: 'Termometer',
        emoji: '🌡️',
        example: { en: 'Can you check my temperature? Sure, here is the thermometer.', id: 'Bisa cek suhu badanku? Bisa, ini termometernya.', emoji: '🌡️' },
        question: {
          en: 'What is used to check the temperature?',
          id: 'Apa yang dipakai untuk memeriksa suhu badan?',
          options: [
            { emoji: '🌡️', text: 'Thermometer', ok: true },
            { emoji: '🩹', text: 'Bandage', ok: false },
            { emoji: '💊', text: 'Pill', ok: false },
            { emoji: '💉', text: 'Syringe', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Plester',
        emoji: '🩹',
        example: { en: 'What happened to your finger, Tono? I cut it. I need a bandage.', id: 'Jarimu kenapa, Tono? Teriris. Aku butuh plester.', emoji: '🩹' },
        question: {
          en: 'What does Tono need for his finger?',
          id: 'Tono butuh apa untuk jarinya?',
          options: [
            { emoji: '🩹', text: 'Bandage', ok: true },
            { emoji: '💊', text: 'Medicine', ok: false },
            { emoji: '🧊', text: 'Ice', ok: false },
      ...
      },
      {
        ...
        id: 'Pilek',
        emoji: '🤧',
        example: { en: 'Do you have a cold, Tono? Yes, I sneeze a lot.', id: 'Kamu pilek, Tono? Iya, aku banyak bersin.', emoji: '🤧' },
        question: {
          en: 'What sickness does Tono have?',
          id: 'Tono sakit apa?',
          options: [
            { emoji: '🤧', text: 'Cold', ok: true },
            { emoji: '🤒', text: 'Fever', ok: false },
            { emoji: '🤕', text: 'Headache', ok: false },
            { emoji: '🦷', text: 'Toothache', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Cepat Sembuh',
        emoji: '💐',
        example: { en: 'Can I go home now? Yes, get well soon, Sari!', id: 'Aku boleh pulang sekarang? Boleh, cepat sembuh, Sari!', emoji: '💐' },
        question: {
          en: 'What does the doctor wish for Sari?',
          id: 'Apa doa dokter untuk Sari?',
          options: [
            { emoji: '💐', text: 'Get Well Soon', ok: true },
            { emoji: '🌙', text: 'Good Night', ok: false },
            { emoji: '🎂', text: 'Happy Birthday', ok: false },
            { emoji: '🍀', text: 'Good Luck', ok: false },
          ],
        },
      },
    ],
    ...
    kenalanGame: [
      {
        ...
        question: {
          en: 'What size is that animal?',
          id: 'Hewan itu berukuran apa?',
          options: [
      ...
      },
      {
        ...
        id: 'Singa',
        emoji: '🦁',
        example: { en: 'What is that animal? It is a lion.', id: 'Hewan apa itu? Itu singa.', emoji: '🦁' },
        question: {
          en: 'Which animal is it?',
          id: 'Hewan apa itu?',
          options: [
            { emoji: '🦁', text: 'Lion', ok: true },
            { emoji: '🐯', text: 'Tiger', ok: false },
            { emoji: '🐻', text: 'Bear', ok: false },
      ...
      },
      {
        ...
        id: 'Di Pohon',
        emoji: '🌳',
        example: { en: 'Where is the koala? It is sleeping in the tree.', id: 'Koalanya di mana? Dia tidur di pohon.', emoji: '🐨' },
        question: {
          en: 'Where is the koala?',
          id: 'Koalanya di mana?',
          options: [
            { emoji: '🌳', text: 'In the Tree', ok: true },
            { emoji: '💧', text: 'In the Water', ok: false },
            { emoji: '🪨', text: 'On the Rock', ok: false },
            { emoji: '🏠', text: 'In the House', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Belang',
        emoji: '🐯',
        example: { en: 'Does the tiger have stripes? Yes, it has black stripes.', id: 'Apakah harimau punya belang? Iya, belangnya hitam.', emoji: '🐯' },
        question: {
          en: 'What does the tiger have on its fur?',
          id: 'Apa yang ada di bulu harimau?',
          options: [
            { emoji: '', text: 'Stripes', ok: true },
            { emoji: '', text: 'Spots', ok: false },
            { emoji: '', text: 'Wings', ok: false },
            { emoji: '', text: 'Horns', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kecil',
        emoji: '🐭',
        example: { en: 'Look at the little mouse! It is very small.', id: 'Lihat tikus kecil itu! Kecil sekali.', emoji: '🐭' },
        question: {
          en: 'What size is the mouse?',
          id: 'Tikusnya berukuran apa?',
          options: [
            { emoji: '', text: 'Small', ok: true },
      ...
      },
      {
        ...
        id: 'Dua',
        emoji: '🕑',
        example: { en: 'When can we feed the animals? At two o’clock.', id: 'Kapan kita boleh memberi makan hewan? Jam dua.', emoji: '🕑' },
        question: {
          en: 'What time is feeding time?',
          id: 'Jam berapa waktu memberi makan?',
          options: [
            { emoji: '🕑', text: 'Two', ok: true },
            { emoji: '🕐', text: 'One', ok: false },
            { emoji: '🕒', text: 'Three', ok: false },
            { emoji: '🕓', text: 'Four', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Bambu',
        emoji: '🎋',
        example: { en: 'What is the panda eating? It is eating bamboo.', id: 'Pandanya makan apa? Dia makan bambu.', emoji: '🐼' },
        question: {
          en: 'What is the panda’s food?',
      ...
      },
      {
        ...
        id: 'Peta',
        emoji: '🗺️',
        example: { en: 'Can I see the zoo map? Here it is, Lia.', id: 'Boleh aku lihat peta kebun binatangnya? Ini dia, Lia.', emoji: '🗺️' },
        question: {
          en: 'What does Lia want to look at?',
          id: 'Lia mau melihat apa?',
          options: [
            { emoji: '🗺️', text: 'Map', ok: true },
            { emoji: '🎫', text: 'Ticket', ok: false },
            { emoji: '📷', text: 'Camera', ok: false },
      ...
      },
      {
        ...
        id: 'Melompat',
        emoji: '🐸',
        example: { en: 'What can the frog do? It can jump very high.', id: 'Katak bisa apa? Dia bisa melompat sangat tinggi.', emoji: '🐸' },
        question: {
          en: 'What is the frog good at?',
          id: 'Katak pandai melakukan apa?',
          options: [
  ...
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Antre',
        emoji: '⏳',
        example: { en: 'Where do I wait? Please wait in line, Lia.', id: 'Aku menunggu di mana? Silakan antre, Lia.', emoji: '🧾' },
        question: {
          en: 'What must Lia do at the cashier?',
          id: 'Apa yang harus Lia lakukan di kasir?',
          options: [
            { emoji: '', text: 'Wait in Line', ok: true },
            { emoji: '', text: 'Sit Down', ok: false },
            { emoji: '', text: 'Run Home', ok: false },
            { emoji: '', text: 'Sing a Song', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dua Puluh Ribu',
        emoji: '💵',
        example: { en: 'How much is it all? It is twenty thousand rupiah.', id: 'Semuanya berapa? Dua puluh ribu rupiah.', emoji: '💵' },
        question: {
          en: 'What is the total price?',
          id: 'Berapa harga totalnya?',
          options: [
            { emoji: '', text: 'Twenty Thousand', ok: true },
            { emoji: '', text: 'Ten Thousand', ok: false },
            { emoji: '', text: 'Fifteen Thousand', ok: false },
            { emoji: '', text: 'Thirty Thousand', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kartu',
        emoji: '💳',
        example: { en: 'Can I pay with a card? Yes, you can, Lia.', id: 'Boleh bayar pakai kartu? Boleh, Lia.', emoji: '💳' },
        question: {
          en: 'How does Lia want to pay?',
          id: 'Lia mau bayar pakai apa?',
          options: [
            { emoji: '💳', text: 'Card', ok: true },
            { emoji: '🪙', text: 'Coin', ok: false },
            { emoji: '💵', text: 'Paper Money', ok: false },
            { emoji: '📱', text: 'Phone', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '👜', text: 'His Own Bag', ok: true },
            { emoji: '📦', text: 'A Box', ok: false },
            { emoji: '🧺', text: 'A Basket', ok: false },
            { emoji: '🧢', text: 'A Hat', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Uang Kembalian',
        emoji: '🪙',
        example: { en: 'Here is your change. Thank you very much!', id: 'Ini uang kembalianmu. Terima kasih banyak!', emoji: '🪙' },
        question: {
          en: 'What does the cashier give back?',
          id: 'Apa yang dikembalikan kasir?',
          options: [
            { emoji: '🪙', text: 'Change', ok: true },
            { emoji: '⚽', text: 'A Ball', ok: false },
            { emoji: '📕', text: 'A Book', ok: false },
            { emoji: '🍬', text: 'A Candy', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Susu',
        emoji: '🥛',
        example: { en: 'What is that beep sound? The cashier scans the milk.', id: 'Bunyi bip apa itu? Kasir memindai susunya.', emoji: '🥛' },
        question: {
          en: 'What does the cashier scan?',
          id: 'Apa yang dipindai kasir?',
          options: [
      ...
      },
      {
        ...
        id: 'Cokelat',
        emoji: '🍫',
        example: { en: 'What do you buy, Rudi? I buy a chocolate bar.', id: 'Kamu beli apa, Rudi? Aku beli sebatang cokelat.', emoji: '🍫' },
        question: {
          en: 'Which snack does Rudi buy?',
          id: 'Camilan apa yang Rudi beli?',
          options: [
            { emoji: '🍫', text: 'Chocolate', ok: true },
            { emoji: '🍬', text: 'Candy', ok: false },
            { emoji: '🍪', text: 'Cookie', ok: false },
            { emoji: '🍟', text: 'Chips', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dompet',
        emoji: '👛',
        example: { en: 'Where is your money, Rudi? It is in my wallet.', id: 'Uangmu di mana, Rudi? Ada di dompetku.', emoji: '👛' },
        question: {
          en: 'Where does Rudi keep his money?',
          id: 'Di mana Rudi menyimpan uangnya?',
          options: [
            { emoji: '👛', text: 'Wallet', ok: true },
            { emoji: '👖', text: 'Pocket', ok: false },
            { emoji: '📦', text: 'Box', ok: false },
            { emoji: '👟', text: 'Shoe', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Berikutnya',
        emoji: '🙋',
        example: { en: 'Next, please! Hello, can I pay here?', id: 'Berikutnya, silakan! Halo, bisa bayar di sini?', emoji: '🧾' },
        question: {
          en: 'What does the cashier say first?',
          id: 'Apa yang pertama diucapkan kasir?',
          options: [
            { emoji: '', text: 'Next, Please', ok: true },
            { emoji: '', text: 'Good Night', ok: false },
            { emoji: '', text: 'Happy Birthday', ok: false },
  ...
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Enam',
        emoji: '🕕',
        example: { en: 'What time do you wake up, Adit? I wake up at six.', id: 'Kamu bangun jam berapa, Adit? Aku bangun jam enam.', emoji: '🕕' },
        question: {
          en: 'What time does Adit get up?',
          id: 'Adit bangun jam berapa?',
          options: [
            { emoji: '🕕', text: 'Six', ok: true },
            { emoji: '🕔', text: 'Five', ok: false },
            { emoji: '🕖', text: 'Seven', ok: false },
            { emoji: '🕗', text: 'Eight', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Setengah Tujuh',
        emoji: '🕡',
        example: { en: 'When do you eat breakfast, Adit? At six thirty.', id: 'Kapan kamu sarapan, Adit? Jam setengah tujuh.', emoji: '🍳' },
        question: {
          en: 'What time is Adit’s breakfast?',
          id: 'Adit sarapan jam berapa?',
          options: [
            { emoji: '🕡', text: 'Six Thirty', ok: true },
            { emoji: '🕢', text: 'Seven Thirty', ok: false },
            { emoji: '🕣', text: 'Eight Thirty', ok: false },
            { emoji: '🕤', text: 'Nine Thirty', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Bus',
        emoji: '🚌',
        example: { en: 'How do you go to school, Adit? I go by bus.', id: 'Kamu ke sekolah naik apa, Adit? Aku naik bus.', emoji: '🚌' },
        question: {
          en: 'How does Adit get to school?',
          id: 'Adit ke sekolah naik apa?',
          options: [
            { emoji: '🚌', text: 'Bus', ok: true },
            { emoji: '🚗', text: 'Car', ok: false },
            { emoji: '🚲', text: 'Bike', ok: false },
            { emoji: '🚆', text: 'Train', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Empat',
        emoji: '🕓',
        example: { en: 'What time is snack time? It is at four o’clock.', id: 'Jam berapa waktu camilan? Jam empat.', emoji: '🍪' },
        question: {
          en: 'When is snack time?',
          id: 'Kapan waktu camilan?',
          options: [
            { emoji: '🕓', text: 'Four', ok: true },
            { emoji: '🕒', text: 'Three', ok: false },
            { emoji: '🕔', text: 'Five', ok: false },
            { emoji: '🕕', text: 'Six', ok: false },
          ],
        },
      },
      {
        en: 'After Dinner',
        id: 'Setelah Makan Malam',
        emoji: '📓',
        example: { en: 'When do you do homework, Adit? I do it after dinner.', id: 'Kapan kamu mengerjakan PR, Adit? Setelah makan malam.', emoji: '📓' },
        question: {
          en: 'When does Adit do his homework?',
          id: 'Kapan Adit mengerjakan PR?',
          options: [
            { emoji: '🍽️', text: 'After Dinner', ok: true },
            { emoji: '🏫', text: 'Before School', ok: false },
            { emoji: '🍱', text: 'At Lunch', ok: false },
            { emoji: '🛏️', text: 'In Bed', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Sikat Gigi',
        emoji: '🪥',
        example: { en: 'What do you do before bed, Adit? I brush my teeth.', id: 'Kamu ngapain sebelum tidur, Adit? Aku sikat gigi.', emoji: '🪥' },
        question: {
          en: 'What does Adit do before bed?',
          id: 'Apa yang Adit lakukan sebelum tidur?',
          options: [
            { emoji: '🪥', text: 'Brush Teeth', ok: true },
            { emoji: '🍬', text: 'Eat Candy', ok: false },
            { emoji: '📺', text: 'Watch TV', ok: false },
            { emoji: '🎮', text: 'Play Games', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Berenang',
        emoji: '🌊',
        example: { en: 'What do you do on Sunday, Adit? I go swimming with Dad.', id: 'Kamu ngapain hari Minggu, Adit? Aku berenang sama Ayah.', emoji: '🌊' },
        question: {
          en: 'What does Adit do on Sunday?',
          id: 'Apa yang Adit lakukan hari Minggu?',
          options: [
            { emoji: '🌊', text: 'Swimming', ok: true },
            { emoji: '🚲', text: 'Cycling', ok: false },
            { emoji: '🎣', text: 'Fishing', ok: false },
            { emoji: '🥾', text: 'Hiking', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Di Rumah',
        emoji: '🏠',
        example: { en: 'Do you go to school on Saturday, Adit? No, I stay at home.', id: 'Kamu sekolah hari Sabtu, Adit? Tidak, aku di rumah saja.', emoji: '🏠' },
        question: {
          en: 'Where is Adit on Saturday?',
          id: 'Adit ada di mana hari Sabtu?',
          options: [
            { emoji: '🏠', text: 'At Home', ok: true },
            { emoji: '🏫', text: 'At School', ok: false },
            { emoji: '🏞️', text: 'At the Park', ok: false },
            { emoji: '🏖️', text: 'At the Beach', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Buku Cerita',
        emoji: '📖',
        example: { en: 'What do you do at night, Adit? I read a story book.', id: 'Kamu ngapain malam hari, Adit? Aku baca buku cerita.', emoji: '📖' },
        question: {
          en: 'What does Adit read at night?',
          id: 'Apa yang Adit baca malam hari?',
          options: [
            { emoji: '📖', text: 'Story Book', ok: true },
            { emoji: '📰', text: 'Newspaper', ok: false },
            { emoji: '✉️', text: 'Letter', ok: false },
            { emoji: '🗺️', text: 'Map', ok: false },
          ],
        },
      },
    ],
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Thailand',
        emoji: '🇹🇭',
        example: { en: 'Where is Mira from? She is from Thailand.', id: 'Mira dari mana? Dia dari Thailand.', emoji: '🇹🇭' },
        question: {
          en: 'Which country is Mira from?',
          id: 'Mira berasal dari negara mana?',
          options: [
            { emoji: '🇹🇭', text: 'Thailand', ok: true },
            { emoji: '🇯🇵', text: 'Japan', ok: false },
            { emoji: '🇮🇳', text: 'India', ok: false },
            { emoji: '🇨🇳', text: 'China', ok: false },
          ],
        },
      },
      {
        en: 'English and Indonesian',
        id: 'Bahasa Inggris dan Indonesia',
        emoji: '🗣️',
        example: { en: 'What languages do you speak, Adi? I speak English and Indonesian.', id: 'Kamu bisa bahasa apa, Adi? Aku bisa bahasa Inggris dan Indonesia.', emoji: '🗣️' },
        question: {
          en: 'What languages does Adi speak?',
          id: 'Adi bisa bahasa apa saja?',
          options: [
            { emoji: '', text: 'English and Indonesian', ok: true },
            { emoji: '', text: 'French and English', ok: false },
            { emoji: '', text: 'Korean and Japanese', ok: false },
            { emoji: '', text: 'Chinese and Arabic', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Brasil',
        emoji: '🇧🇷',
        example: { en: 'Is Pedro from Spain? No, he is from Brazil.', id: 'Apakah Pedro dari Spanyol? Bukan, dia dari Brasil.', emoji: '🇧🇷' },
        question: {
          en: 'Where does Pedro come from?',
          id: 'Pedro berasal dari mana?',
          options: [
            { emoji: '🇧🇷', text: 'Brazil', ok: true },
            { emoji: '🇪🇸', text: 'Spain', ok: false },
            { emoji: '🇲🇽', text: 'Mexico', ok: false },
            { emoji: '🇦🇷', text: 'Argentina', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Australia',
        emoji: '🇦🇺',
        example: { en: 'Where does Emma live? She lives in Australia.', id: 'Emma tinggal di mana? Dia tinggal di Australia.', emoji: '🇦🇺' },
        question: {
          en: 'Which country does Emma live in?',
          id: 'Emma tinggal di negara mana?',
          options: [
            { emoji: '🇦🇺', text: 'Australia', ok: true },
            { emoji: '🇬🇧', text: 'The UK', ok: false },
            { emoji: '🇺🇸', text: 'America', ok: false },
            { emoji: '🇨🇦', text: 'Canada', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Merah dan Putih',
        emoji: '🎌',
        example: { en: 'What color is the flag of Indonesia? It is red and white.', id: 'Bendera Indonesia warnanya apa? Merah dan putih.', emoji: '🎌' },
        question: {
          en: 'What colors are on the flag?',
          id: 'Warna apa saja yang ada di bendera itu?',
          options: [
            { emoji: '', text: 'Red and White', ok: true },
            { emoji: '', text: 'Blue and White', ok: false },
            { emoji: '', text: 'Green and Yellow', ok: false },
            { emoji: '', text: 'Black and Red', ok: false },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        id: 'Piza',
        emoji: '🍕',
        example: { en: 'What food is from Italy? Pizza is from Italy.', id: 'Makanan apa yang dari Italia? Piza dari Italia.', emoji: '🍕' },
        question: {
          en: 'Which food comes from Italy?',
          id: 'Makanan apa yang berasal dari Italia?',
          options: [
            { emoji: '🍕', text: 'Pizza', ok: true },
            { emoji: '🍣', text: 'Sushi', ok: false },
            { emoji: '🍜', text: 'Noodles', ok: false },
            { emoji: '🌮', text: 'Taco', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Pesawat',
        emoji: '✈️',
        example: { en: 'How does your family go to Malaysia? We go by plane.', id: 'Keluargamu ke Malaysia naik apa? Kami naik pesawat.', emoji: '✈️' },
        question: {
          en: 'How does the family travel to Malaysia?',
          id: 'Keluarga itu pergi ke Malaysia naik apa?',
          options: [
            { emoji: '✈️', text: 'Plane', ok: true },
            { emoji: '🚢', text: 'Ship', ok: false },
            { emoji: '🚌', text: 'Bus', ok: false },
            { emoji: '🚆', text: 'Train', ok: false },
          ],
        },
      },
      {
        ...
        id: 'India',
        emoji: '🇮🇳',
        example: { en: 'Where is Raj from? He is from India.', id: 'Raj dari mana? Dia dari India.', emoji: '🇮🇳' },
        question: {
          en: 'What country is Raj’s home?',
          id: 'Negara mana yang jadi asal Raj?',
          options: [
            { emoji: '🇮🇳', text: 'India', ok: true },
            { emoji: '🇹🇭', text: 'Thailand', ok: false },
            { emoji: '🇨🇳', text: 'China', ok: false },
            { emoji: '🇯🇵', text: 'Japan', ok: false },
          ],
        },
  ...
  },
  {
    ...
    drill: [
      { en: 'I blow out the candles.', id: 'Aku meniup lilin-lilinnya.', opts: [{ emoji: '🕯️', ok: true }, { emoji: '🎁' }] },
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '9️⃣', text: 'Nine', ok: true },
            { emoji: '8️⃣', text: 'Eight', ok: false },
            { emoji: '🔟', text: 'Ten', ok: false },
            { emoji: '7️⃣', text: 'Seven', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kue Cokelat',
        emoji: '🍫',
        example: { en: 'What cake do you want, Galih? A chocolate cake, please.', id: 'Kamu mau kue apa, Galih? Kue cokelat, ya.', emoji: '🍰' },
        question: {
          en: 'Which cake does Galih want?',
          id: 'Galih mau kue yang mana?',
          options: [
            { emoji: '🍫', text: 'Chocolate Cake', ok: true },
            { emoji: '🍓', text: 'Strawberry Cake', ok: false },
            { emoji: '🍋', text: 'Lemon Cake', ok: false },
            { emoji: '🥥', text: 'Coconut Cake', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dua Belas',
        emoji: '🎈',
        example: { en: 'How many balloons are there? There are twelve balloons.', id: 'Ada berapa balon? Ada dua belas balon.', emoji: '🎈' },
        question: {
          en: 'How many balloons are at the party?',
          id: 'Ada berapa balon di pesta?',
          options: [
      ...
      },
      {
        ...
        id: 'Topi Pesta',
        emoji: '🥳',
        example: { en: 'What are you wearing, Galih? I am wearing a party hat.', id: 'Kamu pakai apa, Galih? Aku pakai topi pesta.', emoji: '🥳' },
        question: {
          en: 'What is on Galih’s head?',
          id: 'Apa yang ada di kepala Galih?',
          options: [
            { emoji: '🥳', text: 'Party Hat', ok: true },
            { emoji: '👑', text: 'Crown', ok: false },
            { emoji: '🧢', text: 'Cap', ok: false },
            { emoji: '⛑️', text: 'Helmet', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Petak Umpet',
        emoji: '🙈',
        example: { en: 'What game shall we play? Let’s play hide and seek!', id: 'Kita main apa? Ayo main petak umpet!', emoji: '🙈' },
        question: {
          en: 'Which game do the kids play?',
          id: 'Permainan apa yang dimainkan anak-anak?',
          options: [
            { emoji: '', text: 'Hide and Seek', ok: true },
            { emoji: '', text: 'Tag', ok: false },
            { emoji: '', text: 'Chess', ok: false },
            { emoji: '', text: 'Football', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Sabtu',
        emoji: '📅',
        example: { en: 'When is the party? It is on Saturday at four.', id: 'Pestanya kapan? Hari Sabtu jam empat.', emoji: '📅' },
        question: {
          en: 'Which day is the party?',
          id: 'Pestanya hari apa?',
          options: [
      ...
      },
      {
        ...
        id: 'Jus Jeruk',
        emoji: '🍊',
        example: { en: 'What do you want to drink, Galih? Orange juice, please.', id: 'Kamu mau minum apa, Galih? Jus jeruk, ya.', emoji: '🧃' },
        question: {
          en: 'Which drink does Galih ask for?',
          id: 'Minuman apa yang Galih minta?',
          options: [
            { emoji: '🍊', text: 'Orange Juice', ok: true },
            { emoji: '🥛', text: 'Milk', ok: false },
            { emoji: '💧', text: 'Water', ok: false },
            { emoji: '🍵', text: 'Tea', ok: false },
          ],
      ...
      },
      {
        ...
        id: 'Pesulap',
        emoji: '🎩',
        example: { en: 'Who is that funny man? He is a magician.', id: 'Siapa pria lucu itu? Dia pesulap.', emoji: '🎩' },
        question: {
          en: 'Who is the funny guest?',
          id: 'Siapa tamu yang lucu itu?',
          options: [
            { emoji: '🎩', text: 'Magician', ok: true },
            { emoji: '🧑‍⚕️', text: 'Doctor', ok: false },
            { emoji: '🧑‍✈️', text: 'Pilot', ok: false },
            { emoji: '🧑‍🍳', text: 'Chef', ok: false },
          ],
      ...
      },
      {
        ...
        id: 'Terima Kasih Sudah Datang',
        emoji: '🙏',
        example: { en: 'Thank you for coming! It is a great party.', id: 'Terima kasih sudah datang! Pestanya seru sekali.', emoji: '🎉' },
        question: {
          en: 'What does Galih say to his guests?',
          id: 'Apa yang dikatakan Galih kepada tamunya?',
          options: [
            { emoji: '', text: 'Thank You for Coming', ok: true },
            { emoji: '', text: 'Good Morning', ok: false },
            { emoji: '', text: 'Excuse Me', ok: false },
            { emoji: '', text: 'Well Done', ok: false },
          ],
        },
      },
    ],
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Wajan',
        emoji: '🍳',
        example: { en: 'What do you use to fry eggs, Dad? I use a frying pan.', id: 'Ayah pakai apa untuk menggoreng telur? Ayah pakai wajan.', emoji: '🍳' },
        question: {
          en: 'What does Dad use for the eggs?',
          id: 'Ayah pakai apa untuk telurnya?',
          options: [
            { emoji: '🍳', text: 'Frying Pan', ok: true },
            { emoji: '🥣', text: 'Bowl', ok: false },
            { emoji: '🍽️', text: 'Plate', ok: false },
            { emoji: '☕', text: 'Cup', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kulkas',
        emoji: '🧊',
        example: { en: 'Where is the milk? It is in the fridge.', id: 'Susunya di mana? Di kulkas.', emoji: '🥛' },
        question: {
          en: 'Where does the milk stay cold?',
          id: 'Di mana susu tetap dingin?',
          options: [
            { emoji: '', text: 'Fridge', ok: true },
            { emoji: '', text: 'Oven', ok: false },
            { emoji: '', text: 'Sink', ok: false },
            { emoji: '', text: 'Cupboard', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Cuci Tangan',
        emoji: '🧼',
        example: { en: 'What do we do before cooking? We wash our hands.', id: 'Kita ngapain sebelum memasak? Kita cuci tangan.', emoji: '🧼' },
        question: {
          en: 'What comes first before cooking?',
          id: 'Apa yang dilakukan lebih dulu sebelum memasak?',
          options: [
            { emoji: '🧼', text: 'Wash Hands', ok: true },
            { emoji: '🍰', text: 'Eat Cake', ok: false },
            { emoji: '📺', text: 'Watch TV', ok: false },
            { emoji: '🛏️', text: 'Go to Bed', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Mangkuk',
        emoji: '🥣',
        example: { en: 'Where do I put the rice? Put it in the bowl.', id: 'Nasinya aku taruh di mana? Taruh di mangkuk.', emoji: '🍚' },
        question: {
          en: 'Where does the rice go?',
          id: 'Nasinya ditaruh di mana?',
          options: [
            { emoji: '🥣', text: 'Bowl', ok: true },
            { emoji: '☕', text: 'Cup', ok: false },
            { emoji: '📦', text: 'Box', ok: false },
            { emoji: '👜', text: 'Bag', ok: false },
          ],
      ...
      },
      {
        ...
        id: 'Kompor',
        emoji: '🔥',
        example: { en: 'Be careful! The stove is very hot.', id: 'Hati-hati! Kompornya panas sekali.', emoji: '🔥' },
        question: {
          en: 'What is very hot in the kitchen?',
          id: 'Apa yang sangat panas di dapur?',
          options: [
            { emoji: '', text: 'Stove', ok: true },
            { emoji: '', text: 'Fridge', ok: false },
            { emoji: '', text: 'Window', ok: false },
      ...
      },
      {
        ...
        id: 'Kue',
        emoji: '🎂',
        example: { en: 'What are you making, Dad? I am making a cake.', id: 'Ayah bikin apa? Ayah bikin kue.', emoji: '🎂' },
        question: {
          en: 'What is Dad making?',
          id: 'Ayah sedang membuat apa?',
          options: [
      ...
      },
      {
        ...
        id: 'Bawang',
        emoji: '🧅',
        example: { en: 'Why are you crying, Dad? I am cutting onions.', id: 'Kenapa Ayah menangis? Ayah sedang memotong bawang.', emoji: '🧅' },
        question: {
...
export const SPEAKING_TOPICS: AnySpeakingTopic[] = [
  ...
  },
  {
    ...
    desc: '3 latihan bicara',
    model: ['Happy birthday!', 'I blow out the candle.'],
...
export const VOCAB_TOPICS_ADVENTURER: VocabTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Trumpet', id: 'Terompet', emoji: '🎺', example: { en: 'I play the trumpet.', id: 'Aku bermain terompet.', emoji: '🎺' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Notebook', id: 'Buku Tulis', emoji: '📓', example: { en: 'I write in my notebook.', id: 'Aku menulis di buku tulisku.', emoji: '📓' } },
      ...
      { en: 'Paint', id: 'Cat', emoji: '🎨', example: { en: 'She uses paint to color the picture.', id: 'Dia memakai cat untuk mewarnai gambar.', emoji: '🎨' } },
  ...
  },
  {
    ...
    desc: '10 kata',
    items: [
      { en: 'Eye', id: 'Mata', emoji: '👁️', example: { en: 'I close one eye.', id: 'Aku menutup satu mata.', emoji: '👁️' } },
      ...
      { en: 'Foot', id: 'Kaki', emoji: '🦶', example: { en: 'I stand on one foot.', id: 'Aku berdiri dengan satu kaki.', emoji: '🦶' } },
      { en: 'Tooth', id: 'Gigi', emoji: '🦷', example: { en: 'I have a wobbly tooth.', id: 'Gigiku goyang.', emoji: '🦷' } },
      { en: 'Tongue', id: 'Lidah', emoji: '👅', example: { en: 'I stick out my tongue.', id: 'Aku menjulurkan lidahku.', emoji: '👅' } },
      { en: 'Thumb', id: 'Jempol', emoji: '👍', example: { en: 'I hold up my thumb.', id: 'Aku mengacungkan jempolku.', emoji: '👍' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Living Room', id: 'Ruang Keluarga', emoji: '🛋️', example: { en: 'We watch TV in the living room.', id: 'Kami nonton TV di ruang keluarga.', emoji: '🛋️' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Worried', id: 'Khawatir', emoji: '😟', example: { en: 'Mom is worried about me.', id: 'Ibu mengkhawatirkanku.', emoji: '😟' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Open', id: 'Membuka', emoji: '🔓', example: { en: 'I open the door.', id: 'Aku membuka pintu.', emoji: '🔓' } },
      { en: 'Close', id: 'Menutup', emoji: '🔒', example: { en: 'I close the door.', id: 'Aku menutup pintu.', emoji: '🔒' } },
...
export const LISTENING_TOPICS_ADVENTURER: ListeningTopic[] = [
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Paspor dan Tiket',
        emoji: '🛂',
        example: { en: 'What do I need for the trip? You need your passport and ticket.', id: 'Aku butuh apa untuk perjalanan? Kamu butuh paspor dan tiket.', emoji: '🛂' },
        question: {
          en: 'What must a traveler bring?',
          id: 'Apa yang harus dibawa penumpang?',
          options: [
            { emoji: '', text: 'Passport and Ticket', ok: true },
            { emoji: '', text: 'Pillow and Blanket', ok: false },
            { emoji: '', text: 'Book and Pencil', ok: false },
            { emoji: '', text: 'Ball and Kite', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Buku',
        emoji: '🧳',
        example: { en: 'Why is your suitcase so heavy, Kevin? Because I packed many books.', id: 'Kenapa kopermu berat sekali, Kevin? Karena aku bawa banyak buku.', emoji: '🧳' },
        question: {
      ...
      },
      {
        ...
        id: 'Pilot',
        emoji: '🧑‍✈️',
        example: { en: 'Who flies the plane? The pilot does, and she is very friendly.', id: 'Siapa yang menerbangkan pesawat? Pilotnya, dan dia sangat ramah.', emoji: '🧑‍✈️' },
        question: {
          en: 'Who is in charge of flying?',
          id: 'Siapa yang bertugas menerbangkan?',
          options: [
            { emoji: '🧑‍✈️', text: 'Pilot', ok: true },
            { emoji: '🧑‍⚕️', text: 'Doctor', ok: false },
            { emoji: '🧑‍🍳', text: 'Chef', ok: false },
            { emoji: '🧑‍🌾', text: 'Farmer', ok: false },
          ],
      ...
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '', text: 'Window Seat', ok: true },
            { emoji: '', text: 'Middle Seat', ok: false },
            { emoji: '', text: 'Aisle Seat', ok: false },
            { emoji: '', text: 'Back Seat', ok: false },
          ],
        },
      },
      {
        en: 'The Slow Taxi',
        id: 'Taksi yang Lambat',
        emoji: '🚕',
        example: { en: 'Why were you late, Kevin? Because the taxi was very slow.', id: 'Kenapa kamu terlambat, Kevin? Karena taksinya lambat sekali.', emoji: '🚕' },
        question: {
          en: 'What made Kevin late?',
          id: 'Apa yang membuat Kevin terlambat?',
          options: [
            { emoji: '', text: 'The Slow Taxi', ok: true },
            { emoji: '', text: 'The Heavy Rain', ok: false },
            { emoji: '', text: 'The Long Line', ok: false },
            { emoji: '', text: 'The Lost Ticket', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Nenek',
        emoji: '👵',
        example: { en: 'What did you buy at the airport shop, Kevin? I bought some sweets for Grandma.', id: 'Kamu beli apa di toko bandara, Kevin? Aku beli permen untuk Nenek.', emoji: '🍬' },
        question: {
          en: 'Who are the sweets for?',
          id: 'Permen itu untuk siapa?',
          options: [
      ...
      },
      {
        ...
        id: 'Bali',
        emoji: '🏝️',
        example: { en: 'Where are you flying to, Kevin? We are flying to Bali for a holiday.', id: 'Kamu terbang ke mana, Kevin? Kami terbang ke Bali untuk liburan.', emoji: '🏝️' },
        question: {
          en: 'Where is Kevin’s family going?',
          id: 'Keluarga Kevin pergi ke mana?',
          options: [
            { emoji: '', text: 'Bali', ok: true },
            { emoji: '', text: 'Jakarta', ok: false },
            { emoji: '', text: 'Tokyo', ok: false },
            { emoji: '', text: 'Paris', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Pesawat',
        emoji: '✈️',
        example: { en: 'Which is faster, a plane or a ship? A plane is much faster.', id: 'Mana yang lebih cepat, pesawat atau kapal? Pesawat jauh lebih cepat.', emoji: '✈️' },
        question: {
          en: 'Which one is much faster?',
          id: 'Mana yang jauh lebih cepat?',
          options: [
            { emoji: '✈️', text: 'Plane', ok: true },
            { emoji: '🚢', text: 'Ship', ok: false },
            { emoji: '🚌', text: 'Bus', ok: false },
      ...
      },
      {
        ...
        id: 'Meja Bantuan',
        emoji: '🛎️',
        example: { en: 'I lost my bag! Don’t worry, we can ask at the help desk.', id: 'Tasku hilang! Jangan khawatir, kita bisa tanya di meja bantuan.', emoji: '🛎️' },
        question: {
          en: 'Where can they ask about the lost bag?',
          id: 'Di mana mereka bisa bertanya soal tas yang hilang?',
          options: [
            { emoji: '', text: 'Help Desk', ok: true },
            { emoji: '', text: 'Toilet', ok: false },
            { emoji: '', text: 'Café', ok: false },
            { emoji: '', text: 'Parking Lot', ok: false },
          ],
        },
      },
    ],
   ...
   */
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Restoran',
        emoji: '🧑‍🍳',
        example: { en: 'What does a chef do? A chef cooks tasty food in a restaurant.', id: 'Apa pekerjaan koki? Koki memasak makanan enak di restoran.', emoji: '🧑‍🍳' },
        question: {
          en: 'Where does a chef work?',
          id: 'Koki bekerja di mana?',
          options: [
            { emoji: '🍽️', text: 'Restaurant', ok: true },
      ...
      },
      {
        ...
        question: {
          ...
          id: 'Kenapa Galang mau jadi dokter hewan?',
          options: [
            { emoji: '', text: 'He Loves Animals', ok: true },
            { emoji: '', text: 'He Loves Cars', ok: false },
            { emoji: '', text: 'He Loves Books', ok: false },
            { emoji: '', text: 'He Loves Music', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Di Bulan',
        emoji: '🧑‍🚀',
        example: { en: 'What did you dream about, Galang? I dreamed I was an astronaut on the moon.', id: 'Kamu mimpi apa, Galang? Aku mimpi jadi astronaut di bulan.', emoji: '🌙' },
        question: {
          en: 'Where was Galang in his dream?',
          id: 'Di mana Galang dalam mimpinya?',
          options: [
            { emoji: '🌙', text: 'On the Moon', ok: true },
            { emoji: '🌊', text: 'Under the Sea', ok: false },
            { emoji: '🏰', text: 'In a Castle', ok: false },
            { emoji: '🌴', text: 'In a Jungle', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Padi dan Jagung',
        emoji: '🧑‍🌾',
        example: { en: 'What does the farmer grow? She grows rice and corn.', id: 'Petani menanam apa? Dia menanam padi dan jagung.', emoji: '🌾' },
        question: {
          en: 'What grows on the farmer’s land?',
          id: 'Apa yang tumbuh di lahan petani?',
          options: [
            { emoji: '', text: 'Rice and Corn', ok: true },
            { emoji: '', text: 'Apples and Pears', ok: false },
            { emoji: '', text: 'Roses and Tulips', ok: false },
            { emoji: '', text: 'Tea and Coffee', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Polisi',
        emoji: '👮',
        example: { en: 'Who helps us cross the road? The police officer helps us.', id: 'Siapa yang membantu kita menyeberang jalan? Polisi membantu kita.', emoji: '👮' },
        question: {
          en: 'Who keeps the road safe?',
          id: 'Siapa yang menjaga jalan tetap aman?',
          options: [
            { emoji: '👮', text: 'Police Officer', ok: true },
            { emoji: '🧑‍🍳', text: 'Chef', ok: false },
            { emoji: '🧑‍🎨', text: 'Artist', ok: false },
            { emoji: '🧑‍✈️', text: 'Pilot', ok: false },
          ],
        },
      },
      ...
      },
      {
        ...
        id: 'Montir',
        emoji: '🧑‍🔧',
        example: { en: 'Who fixed our car yesterday? The mechanic fixed it.', id: 'Siapa yang memperbaiki mobil kita kemarin? Montir yang memperbaikinya.', emoji: '🔧' },
        question: {
          en: 'Who repaired the car?',
          id: 'Siapa yang memperbaiki mobilnya?',
          options: [
            { emoji: '🧑‍🔧', text: 'Mechanic', ok: true },
            { emoji: '🧑‍🏫', text: 'Teacher', ok: false },
            { emoji: '🧑‍⚕️', text: 'Doctor', ok: false },
            { emoji: '🧑‍🌾', text: 'Farmer', ok: false },
          ],
      ...
      },
      {
        ...
        id: 'Ilmuwan',
        emoji: '🧑‍🔬',
        example: { en: 'Which job is more exciting, a scientist or a teacher, Galang? I think a scientist is more exciting.', id: 'Pekerjaan mana yang lebih seru, ilmuwan atau guru, Galang? Menurutku ilmuwan lebih seru.', emoji: '🔬' },
        question: {
          en: 'Which job does Galang find more exciting?',
          id: 'Pekerjaan mana yang menurut Galang lebih seru?',
          options: [
            { emoji: '🧑‍🔬', text: 'Scientist', ok: true },
            { emoji: '🧑‍🏫', text: 'Teacher', ok: false },
            { emoji: '🧑‍🍳', text: 'Chef', ok: false },
            { emoji: '🧑‍✈️', text: 'Pilot', ok: false },
          ],
    ...
    kenalanGame: [
      {
        ...
        id: 'Jip',
        emoji: '🚙',
        example: { en: 'How do we travel on the safari? We ride in a big jeep.', id: 'Kita naik apa di safari? Kita naik jip besar.', emoji: '🚙' },
        question: {
          en: 'What vehicle is used on the safari?',
          id: 'Kendaraan apa yang dipakai di safari?',
          options: [
            { emoji: '🚙', text: 'Jeep', ok: true },
            { emoji: '⛵', text: 'Boat', ok: false },
            { emoji: '🚆', text: 'Train', ok: false },
            { emoji: '🚲', text: 'Bike', ok: false },
          ],
        },
      ...
      {
        en: 'In the Tall Grass',
        id: 'Di Rumput Tinggi',
        emoji: '🐯',
        example: { en: 'Did you see the tiger, Fajar? Yes, it was hiding in the tall grass.', id: 'Kamu lihat harimaunya, Fajar? Iya, dia bersembunyi di rumput tinggi.', emoji: '🌾' },
        question: {
          en: 'Where was the tiger?',
          id: 'Harimaunya ada di mana?',
          options: [
            { emoji: '🌾', text: 'In the Tall Grass', ok: true },
            { emoji: '🌊', text: 'In the River', ok: false },
            { emoji: '🪨', text: 'On a Rock', ok: false },
            { emoji: '🌳', text: 'In a Tree', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Topinya',
        emoji: '🐵',
        example: { en: 'What did the monkey take, Fajar? It took my hat!', id: 'Monyet itu mengambil apa, Fajar? Dia mengambil topiku!', emoji: '🧢' },
        question: {
          en: 'What did the monkey grab from Fajar?',
          id: 'Apa yang direbut monyet itu dari Fajar?',
          options: [
            { emoji: '🧢', text: 'His Hat', ok: true },
            { emoji: '📷', text: 'His Camera', ok: false },
            { emoji: '🎒', text: 'His Bag', ok: false },
            { emoji: '💧', text: 'His Water', ok: false },
          ],
        },
      },
      {
        en: 'The Animals Are Far',
        id: 'Hewannya Jauh',
        emoji: '🔭',
        example: { en: 'Why do you need binoculars, Fajar? Because the animals are far away.', id: 'Kenapa kamu butuh teropong, Fajar? Karena hewannya jauh sekali.', emoji: '🔭' },
        question: {
          en: 'Why does Fajar need binoculars?',
          id: 'Kenapa Fajar butuh teropong?',
          options: [
            { emoji: '', text: 'The Animals Are Far', ok: true },
            { emoji: '', text: 'The Sun Is Hot', ok: false },
            { emoji: '', text: 'The Jeep Is Fast', ok: false },
            { emoji: '', text: 'The Grass Is Green', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kuda Nil',
        emoji: '🌊',
        example: { en: 'What lives in the river? Big hippos live there.', id: 'Apa yang tinggal di sungai? Kuda nil besar tinggal di sana.', emoji: '🌊' },
        question: {
          en: 'Which animal lives in the river?',
          id: 'Hewan apa yang tinggal di sungai?',
          options: [
            { emoji: '', text: 'Hippos', ok: true },
            { emoji: '', text: 'Lions', ok: false },
            { emoji: '', text: 'Tigers', ok: false },
            { emoji: '', text: 'Monkeys', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dua Puluh',
        emoji: '📷',
        example: { en: 'I took twenty photos of the animals today.', id: 'Hari ini aku mengambil dua puluh foto hewan.', emoji: '📷' },
        question: {
          en: 'How many photos were taken?',
          id: 'Berapa foto yang diambil?',
          options: [
      ...
      },
      {
        ...
        id: 'Cuacanya Panas',
        emoji: '☀️',
        example: { en: 'It was hotter than yesterday, so we wore hats.', id: 'Cuacanya lebih panas dari kemarin, jadi kami memakai topi.', emoji: '👒' },
        question: {
          en: 'Why were hats needed?',
          id: 'Kenapa topi dibutuhkan?',
          options: [
            { emoji: '', text: 'It Was Hot', ok: true },
            { emoji: '', text: 'It Was Rainy', ok: false },
            { emoji: '', text: 'It Was Windy', ok: false },
            { emoji: '', text: 'It Was Dark', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Tenda',
        emoji: '⛺',
        example: { en: 'Where did you sleep last night, Fajar? We slept in a tent.', id: 'Semalam kamu tidur di mana, Fajar? Kami tidur di tenda.', emoji: '⛺' },
        question: {
          en: 'Where did Fajar’s group sleep?',
          id: 'Rombongan Fajar tidur di mana?',
          options: [
            { emoji: '⛺', text: 'Tent', ok: true },
            { emoji: '🏨', text: 'Hotel', ok: false },
            { emoji: '🏠', text: 'House', ok: false },
            { emoji: '🚗', text: 'Car', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Pemandu',
        emoji: '🧭',
        example: { en: 'Who showed us the way? Our guide, Mr. Budi, did.', id: 'Siapa yang menunjukkan jalan? Pemandu kami, Pak Budi.', emoji: '🧭' },
        question: {
          en: 'Who led the group?',
          id: 'Siapa yang memimpin rombongan?',
          options: [
            { emoji: '🧭', text: 'The Guide', ok: true },
            { emoji: '🚗', text: 'The Driver', ok: false },
            { emoji: '🍳', text: 'The Cook', ok: false },
            { emoji: '✈️', text: 'The Pilot', ok: false },
          ],
        },
      },
      {
  ...
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Di Masjid',
        emoji: '🕌',
        example: { en: 'Where is Grandpa? He is still at the mosque.', id: 'Kakek di mana? Dia masih di masjid.', emoji: '🕌' },
        question: {
          en: 'Where is Grandpa now?',
          id: 'Kakek sekarang di mana?',
          options: [
            { emoji: '🕌', text: 'At the Mosque', ok: true },
            { emoji: '🛒', text: 'At the Market', ok: false },
            { emoji: '🏞️', text: 'At the Park', ok: false },
            { emoji: '🏫', text: 'At the School', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '🌶️', text: 'Spicy', ok: true },
            { emoji: '🍬', text: 'Sweet', ok: false },
            { emoji: '🍋', text: 'Sour', ok: false },
            { emoji: '🧂', text: 'Salty', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Puding Mangga',
        emoji: '🥭',
        example: { en: 'What is for dessert? We have sweet mango pudding.', id: 'Pencuci mulutnya apa? Ada puding mangga yang manis.', emoji: '🥭' },
        question: {
          en: 'What is the sweet food after dinner?',
          id: 'Apa makanan manis setelah makan malam?',
          options: [
            { emoji: '🥭', text: 'Mango Pudding', ok: true },
            { emoji: '🍰', text: 'Chocolate Cake', ok: false },
            { emoji: '🍨', text: 'Ice Cream', ok: false },
            { emoji: '🍌', text: 'Banana Bread', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '', text: 'They Played Games', ok: true },
            { emoji: '', text: 'They Had a Test', ok: false },
            { emoji: '', text: 'It Was Short', ok: false },
            { emoji: '', text: 'They Went Home Early', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Hadi',
        emoji: '🧽',
        example: { en: 'Whose turn is it to wash the dishes? It is Hadi’s turn tonight.', id: 'Giliran siapa cuci piring? Malam ini giliran Hadi.', emoji: '🧽' },
        question: {
          en: 'Who washes the dishes tonight?',
          id: 'Siapa yang mencuci piring malam ini?',
          options: [
            { emoji: '', text: 'Hadi', ok: true },
      ...
      },
      {
        ...
        question: {
          ...
          id: 'Kenapa sayur baik untuk kita?',
          options: [
            { emoji: '', text: 'They Make Us Strong', ok: true },
            { emoji: '', text: 'They Are Sweet', ok: false },
            { emoji: '', text: 'They Are Cheap', ok: false },
            { emoji: '', text: 'They Are Blue', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Garam',
        emoji: '🧂',
        example: { en: 'Could you pass the salt, please? Here you go.', id: 'Boleh tolong ambilkan garamnya? Ini dia.', emoji: '🧂' },
        question: {
          en: 'What is passed at the table?',
          id: 'Apa yang diambilkan di meja makan?',
          options: [
            { emoji: '🧂', text: 'Salt', ok: true },
            { emoji: '💧', text: 'Water', ok: false },
            { emoji: '🍚', text: 'Rice', ok: false },
            { emoji: '🥚', text: 'Egg', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dia Kenyang',
        emoji: '😌',
        example: { en: 'Do you want more rice, Hadi? No, thank you. I am full.', id: 'Mau tambah nasi, Hadi? Tidak, terima kasih. Aku sudah kenyang.', emoji: '🍚' },
        question: {
          en: 'Why does Hadi say no to more rice?',
          id: 'Kenapa Hadi menolak tambah nasi?',
          options: [
            { emoji: '', text: 'He Is Full', ok: true },
            { emoji: '', text: 'He Is Sick', ok: false },
            { emoji: '', text: 'He Is Angry', ok: false },
            { emoji: '', text: 'He Is Late', ok: false },
          ],
        },
      },
    ],
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Lem',
        emoji: '📄',
        example: { en: 'What do I need to stick the paper? You need some glue.', id: 'Aku butuh apa untuk menempel kertas? Kamu butuh lem.', emoji: '📄' },
        question: {
          en: 'What helps stick the paper?',
          id: 'Apa yang membantu menempel kertas?',
          options: [
            { emoji: '', text: 'Glue', ok: true },
            { emoji: '', text: 'Water', ok: false },
            { emoji: '', text: 'Sand', ok: false },
            { emoji: '', text: 'Salt', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Pohon',
        emoji: '🌳',
        example: { en: 'What did you draw yesterday, Beni? I drew a big tree.', id: 'Kemarin kamu menggambar apa, Beni? Aku menggambar pohon besar.', emoji: '🌳' },
        question: {
          en: 'What was in Beni’s drawing?',
          id: 'Apa yang ada di gambar Beni?',
          options: [
            { emoji: '🌳', text: 'A Tree', ok: true },
            { emoji: '🏠', text: 'A House', ok: false },
            { emoji: '🚗', text: 'A Car', ok: false },
            { emoji: '⛵', text: 'A Boat', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Hijau',
        emoji: '🟢',
        example: { en: 'What do I get if I mix blue and yellow? You get green!', id: 'Kalau biru dan kuning dicampur jadi apa? Jadi hijau!', emoji: '🎨' },
        question: {
          en: 'Which color do the two colors make?',
          id: 'Dua warna itu menghasilkan warna apa?',
          options: [
      ...
      },
      {
        ...
        id: 'Cangkir',
        emoji: '☕',
        example: { en: 'What are you making with the clay, Beni? I am making a little cup.', id: 'Kamu bikin apa dari tanah liat, Beni? Aku bikin cangkir kecil.', emoji: '☕' },
        question: {
          en: 'What is Beni shaping from clay?',
          id: 'Apa yang Beni bentuk dari tanah liat?',
          options: [
            { emoji: '☕', text: 'A Cup', ok: true },
            { emoji: '🚗', text: 'A Car', ok: false },
            { emoji: '⚽', text: 'A Ball', ok: false },
      ...
      },
      {
        ...
        id: 'Rina',
        emoji: '🖼️',
        example: { en: 'Who is the best painter in class? Rina paints the most beautiful pictures.', id: 'Siapa pelukis terbaik di kelas? Rina melukis gambar paling indah.', emoji: '🖼️' },
        question: {
          en: 'Who paints the best?',
          id: 'Siapa yang melukis paling bagus?',
          options: [
            { emoji: '', text: 'Rina', ok: true },
            { emoji: '', text: 'Dodi', ok: false },
            { emoji: '', text: 'Tari', ok: false },
            { emoji: '', text: 'Beni', ok: false },
          ],
        },
      },
      {
        en: 'To Use a New Color',
        id: 'Untuk Pakai Warna Baru',
        emoji: '🖌️',
        example: { en: 'Why are you washing the brush, Beni? Because I want to use a new color.', id: 'Kenapa kamu mencuci kuasnya, Beni? Karena aku mau pakai warna baru.', emoji: '🖌️' },
        question: {
          en: 'Why is Beni washing the brush?',
          id: 'Kenapa Beni mencuci kuasnya?',
          options: [
            { emoji: '', text: 'To Use a New Color', ok: true },
            { emoji: '', text: 'To Make It Wet', ok: false },
            { emoji: '', text: 'To Break It', ok: false },
            { emoji: '', text: 'To Hide It', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Celemek',
        emoji: '👕',
        example: { en: 'Please wear an apron so your shirt stays clean.', id: 'Tolong pakai celemek supaya bajumu tetap bersih.', emoji: '👕' },
        question: {
          en: 'What should the students wear?',
          id: 'Apa yang harus dipakai para murid?',
          options: [
            { emoji: '', text: 'An Apron', ok: true },
            { emoji: '', text: 'A Coat', ok: false },
            { emoji: '', text: 'A Scarf', ok: false },
            { emoji: '', text: 'A Raincoat', ok: false },
          ],
        },
      },
      {
        en: 'On the Bedroom Wall',
        id: 'Di Dinding Kamar',
        emoji: '🖼️',
        example: { en: 'Where did you hang your painting, Beni? I hung it on my bedroom wall.', id: 'Lukisanmu kamu gantung di mana, Beni? Aku gantung di dinding kamarku.', emoji: '🛏️' },
        question: {
          en: 'Where is Beni’s painting now?',
          id: 'Di mana lukisan Beni sekarang?',
          options: [
            { emoji: '', text: 'On the Bedroom Wall', ok: true },
            { emoji: '', text: 'In the Kitchen', ok: false },
            { emoji: '', text: 'In the Car', ok: false },
            { emoji: '', text: 'Under the Bed', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          id: 'Ada berapa lingkaran di kertas Beni?',
          options: [
  ...
  },
  {
    ...
    kenalanGame: [
      ...
      {
        en: 'The Sky Looks Dark',
        id: 'Langitnya Gelap',
        emoji: '☂️',
        example: { en: 'Why do you have an umbrella, Yoga? Because the sky looks dark.', id: 'Kenapa kamu bawa payung, Yoga? Karena langitnya kelihatan gelap.', emoji: '☂️' },
        question: {
          en: 'Why does Yoga carry an umbrella?',
          id: 'Kenapa Yoga membawa payung?',
          options: [
            { emoji: '', text: 'The Sky Looks Dark', ok: true },
            { emoji: '', text: 'It Is His Birthday', ok: false },
            { emoji: '', text: 'He Is Hungry', ok: false },
            { emoji: '', text: 'The Sun Is Bright', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Pelangi',
        emoji: '🌈',
        example: { en: 'What did you see after the rain, Yoga? I saw a beautiful rainbow.', id: 'Kamu lihat apa setelah hujan, Yoga? Aku lihat pelangi yang indah.', emoji: '🌈' },
        question: {
          en: 'What appeared after the rain?',
          id: 'Apa yang muncul setelah hujan?',
          options: [
            { emoji: '🌈', text: 'Rainbow', ok: true },
            { emoji: '🌙', text: 'Moon', ok: false },
      ...
      },
      {
        ...
        id: 'Guntur',
        emoji: '⛈️',
        example: { en: 'What is that loud noise? It is thunder. A storm is coming.', id: 'Suara keras apa itu? Itu guntur. Badai akan datang.', emoji: '⛈️' },
        question: {
          en: 'What makes the loud noise?',
          id: 'Apa yang membuat suara keras itu?',
          options: [
            { emoji: '⛈️', text: 'Thunder', ok: true },
            { emoji: '🥁', text: 'A Drum', ok: false },
            { emoji: '🚗', text: 'A Car', ok: false },
            { emoji: '🔔', text: 'A Bell', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Jakarta',
        emoji: '🌡️',
        example: { en: 'Is it hotter in Jakarta or in Bandung? Jakarta is hotter.', id: 'Lebih panas di Jakarta atau di Bandung? Jakarta lebih panas.', emoji: '🌡️' },
        question: {
          en: 'Which city is hotter?',
          id: 'Kota mana yang lebih panas?',
          options: [
            { emoji: '', text: 'Jakarta', ok: true },
            { emoji: '', text: 'Bandung', ok: false },
            { emoji: '', text: 'Bogor', ok: false },
            { emoji: '', text: 'Malang', ok: false },
          ],
        },
      },
      {
        ...
        id: 'November',
        emoji: '📅',
        example: { en: 'When does the rainy season start? It usually starts in November.', id: 'Kapan musim hujan dimulai? Biasanya mulai bulan November.', emoji: '🌧️' },
        question: {
          en: 'In which month does the rainy season begin?',
          id: 'Musim hujan mulai bulan apa?',
          options: [
            { emoji: '', text: 'November', ok: true },
            { emoji: '', text: 'June', ok: false },
            { emoji: '', text: 'March', ok: false },
            { emoji: '', text: 'August', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Anginnya Kencang',
        emoji: '🪁',
        example: { en: 'Is it a good day to fly a kite? Yes, it is very windy.', id: 'Hari ini cocok main layangan? Iya, anginnya kencang sekali.', emoji: '🪁' },
        question: {
          en: 'Why is it a good day for kites?',
          id: 'Kenapa hari ini cocok untuk layangan?',
          options: [
            { emoji: '', text: 'It Is Windy', ok: true },
            { emoji: '', text: 'It Is Rainy', ok: false },
            { emoji: '', text: 'It Is Foggy', ok: false },
            { emoji: '', text: 'It Is Dark', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '', text: 'Raincoat and Boots', ok: true },
            { emoji: '', text: 'Swimsuit and Hat', ok: false },
            { emoji: '', text: 'Pajamas and Slippers', ok: false },
            { emoji: '', text: 'Shorts and Sandals', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Radio',
        emoji: '📻',
        example: { en: 'Where did you hear the weather forecast, Yoga? I heard it on the radio.', id: 'Kamu dengar ramalan cuaca di mana, Yoga? Aku dengar di radio.', emoji: '📻' },
        question: {
          en: 'Where did Yoga hear the forecast?',
          id: 'Yoga mendengar ramalan cuaca dari mana?',
          options: [
            { emoji: '📻', text: 'Radio', ok: true },
            { emoji: '📺', text: 'TV', ok: false },
            { emoji: '📱', text: 'Phone', ok: false },
            { emoji: '📰', text: 'Newspaper', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Berkabut',
        emoji: '🌫️',
        example: { en: 'I could not see the road this morning because it was foggy.', id: 'Tadi pagi aku tidak bisa melihat jalan karena berkabut.', emoji: '🌫️' },
        question: {
          en: 'Why was the road hard to see?',
          id: 'Kenapa jalannya sulit terlihat?',
          options: [
            { emoji: '', text: 'It Was Foggy', ok: true },
            { emoji: '', text: 'It Was Sunny', ok: false },
            { emoji: '', text: 'It Was Hot', ok: false },
            { emoji: '', text: 'It Was Windy', ok: false },
          ],
        },
      },
  ...
  },
  {
    ...
    drill: [
      { en: 'I wash my hands.', id: 'Aku mencuci tanganku.', opts: [{ emoji: '✋', ok: true }, { emoji: '🦶' }] },
    ...
    kenalanGame: [
      {
        ...
        id: 'Menyikat Gigi',
        emoji: '🪥',
        example: { en: 'What are you doing? I am brushing my teeth.', id: 'Kamu sedang apa? Aku sedang menyikat gigiku.', emoji: '🪥' },
        question: {
          en: 'What is he doing?',
          id: 'Dia sedang apa?',
          options: [
      ...
      {
        en: 'His Hair Is Messy',
        id: 'Rambutnya Berantakan',
        emoji: '🪮',
        example: { en: 'Why do you need the comb, Dodi? Because my hair is messy.', id: 'Kenapa kamu butuh sisir, Dodi? Karena rambutku berantakan.', emoji: '🪮' },
        question: {
          en: 'Why does Dodi need the comb?',
          id: 'Kenapa Dodi butuh sisir?',
          options: [
            { emoji: '', text: 'His Hair Is Messy', ok: true },
            { emoji: '', text: 'His Face Is Dirty', ok: false },
            { emoji: '', text: 'His Shoes Are Wet', ok: false },
            { emoji: '', text: 'His Bag Is Heavy', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Sabun',
        emoji: '🧼',
        example: { en: 'Did you wash your face this morning, Dodi? Yes, I washed it with soap.', id: 'Tadi pagi kamu cuci muka, Dodi? Iya, aku cuci pakai sabun.', emoji: '🧼' },
        question: {
          en: 'What did Dodi use to wash his face?',
          id: 'Dodi mencuci muka pakai apa?',
          options: [
            { emoji: '🧼', text: 'Soap', ok: true },
            { emoji: '🥛', text: 'Milk', ok: false },
            { emoji: '🧃', text: 'Juice', ok: false },
            { emoji: '🧂', text: 'Salt', ok: false },
          ],
      ...
      },
      {
        ...
        question: {
          ...
          options: [
            ...
            { emoji: '', text: 'Long Hair', ok: false },
            { emoji: '', text: 'Red Nose', ok: false },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        question: {
          ...
          id: 'Lia butuh bantuan untuk apa?',
          options: [
            { emoji: '', text: 'Buttons', ok: true },
            { emoji: '', text: 'Shoelaces', ok: false },
            { emoji: '', text: 'Socks', ok: false },
            { emoji: '', text: 'Glasses', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Di Kepalanya',
        emoji: '👓',
        example: { en: 'Where are my glasses? They are on your head, Lia!', id: 'Kacamataku di mana? Ada di kepalamu, Lia!', emoji: '👓' },
        question: {
          en: 'Where are Lia’s glasses?',
          id: 'Di mana kacamata Lia?',
          options: [
            { emoji: '', text: 'On Her Head', ok: true },
            { emoji: '', text: 'On the Table', ok: false },
            { emoji: '', text: 'In the Bag', ok: false },
            { emoji: '', text: 'Under the Bed', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Adiknya',
        emoji: '📏',
        example: { en: 'Look! I am taller than my brother now.', id: 'Lihat! Sekarang aku lebih tinggi dari adikku.', emoji: '📏' },
        question: {
          en: 'Who is shorter now?',
          id: 'Siapa yang sekarang lebih pendek?',
          options: [
      ...
      },
      {
        ...
        id: 'Sedikit Saja',
        emoji: '🪥',
        example: { en: 'How much toothpaste do I need? Just a little, the size of a pea.', id: 'Aku butuh pasta gigi berapa banyak? Sedikit saja, sebesar kacang polong.', emoji: '🪥' },
        question: {
          en: 'How much toothpaste is enough?',
          id: 'Berapa banyak pasta gigi yang cukup?',
          options: [
            { emoji: '', text: 'Just a Little', ok: true },
            { emoji: '', text: 'A Whole Tube', ok: false },
            { emoji: '', text: 'Two Cups', ok: false },
            { emoji: '', text: 'None', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          id: 'Kenapa Dodi membersihkan telinganya?',
          options: [
            { emoji: '', text: 'To Hear Well', ok: true },
            { emoji: '', text: 'To See Better', ok: false },
            { emoji: '', text: 'To Run Fast', ok: false },
            { emoji: '', text: 'To Sing Loudly', ok: false },
          ],
        },
      },
    ],
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Mesin Tiket',
        emoji: '🎫',
        example: { en: 'Where can I buy a ticket? At the ticket machine over there.', id: 'Aku bisa beli tiket di mana? Di mesin tiket sebelah sana.', emoji: '🎫' },
        question: {
          en: 'Where can tickets be bought?',
          id: 'Tiket bisa dibeli di mana?',
          options: [
            { emoji: '', text: 'Ticket Machine', ok: true },
            { emoji: '', text: 'Café', ok: false },
            { emoji: '', text: 'Toilet', ok: false },
            { emoji: '', text: 'Bus Stop', ok: false },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        id: 'Hujan Deras',
        emoji: '🌧️',
        example: { en: 'Why is the train late? Because it is raining heavily.', id: 'Kenapa keretanya terlambat? Karena hujan deras.', emoji: '🌧️' },
        question: {
          en: 'What made the train late?',
          id: 'Apa yang membuat kereta terlambat?',
          options: [
            { emoji: '🌧️', text: 'Heavy Rain', ok: true },
            { emoji: '🎉', text: 'A Party', ok: false },
            { emoji: '🚧', text: 'A Broken Road', ok: false },
            { emoji: '🚦', text: 'A Red Light', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kursi',
        emoji: '💺',
        example: { en: 'Is this seat free? Yes, you can sit here.', id: 'Kursi ini kosong? Iya, kamu boleh duduk di sini.', emoji: '💺' },
        question: {
          en: 'What is the question about?',
          id: 'Pertanyaannya soal apa?',
          options: [
            { emoji: '💺', text: 'The Seat', ok: true },
            { emoji: '🎫', text: 'The Ticket', ok: false },
            { emoji: '🕐', text: 'The Time', ok: false },
      ...
      },
      {
        ...
        id: 'Lebih Murah',
        emoji: '💰',
        example: { en: 'Is the train slower than the plane? Yes, but the train is cheaper.', id: 'Apakah kereta lebih lambat dari pesawat? Iya, tapi kereta lebih murah.', emoji: '🚆' },
        question: {
          en: 'What is better about the train?',
          id: 'Apa kelebihan kereta?',
          options: [
            { emoji: '', text: 'It Is Cheaper', ok: true },
            { emoji: '', text: 'It Is Faster', ok: false },
            { emoji: '', text: 'It Is Bigger', ok: false },
            { emoji: '', text: 'It Is Newer', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Roti Isi',
        emoji: '🥪',
        example: { en: 'What did you eat on the train, Rafa? I ate a sandwich and drank tea.', id: 'Kamu makan apa di kereta, Rafa? Aku makan roti isi dan minum teh.', emoji: '🥪' },
        question: {
          en: 'What did Rafa eat on the train?',
          id: 'Rafa makan apa di kereta?',
          options: [
            { emoji: '🥪', text: 'Sandwich', ok: true },
            { emoji: '🍕', text: 'Pizza', ok: false },
            { emoji: '🍜', text: 'Noodles', ok: false },
            { emoji: '🥗', text: 'Salad', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '', text: 'To Visit Grandma', ok: true },
            { emoji: '', text: 'To Buy Shoes', ok: false },
            { emoji: '', text: 'To See a Movie', ok: false },
            { emoji: '', text: 'To Go to School', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          id: 'Siapa yang melihat tiket di kereta?',
          options: [
            { emoji: '', text: 'Conductor', ok: true },
            { emoji: '', text: 'Chef', ok: false },
            { emoji: '', text: 'Doctor', ok: false },
            { emoji: '', text: 'Farmer', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Tujuh',
        emoji: '🕖',
        example: { en: 'What time did the train arrive? It arrived at seven o’clock.', id: 'Keretanya tiba jam berapa? Tiba jam tujuh.', emoji: '🕖' },
        question: {
          en: 'When did the train get there?',
          id: 'Kapan keretanya sampai?',
          options: [
            { emoji: '🕖', text: 'Seven', ok: true },
            { emoji: '🕕', text: 'Six', ok: false },
            { emoji: '🕗', text: 'Eight', ok: false },
            { emoji: '🕘', text: 'Nine', ok: false },
          ],
  ...
  },
  {
    ...
    question: { en: 'What does Rio do after badminton?', id: 'Apa yang dilakukan Rio setelah bulu tangkis?', opts: [{ emoji: '🌊', lbl: 'Swimming', ok: true }, { emoji: '🎾', lbl: 'Tennis' }], decoys: [{ emoji: '🏐', lbl: 'Volleyball' }, { emoji: '⚽', lbl: 'Football' }] },
    kenalanGame: [
      {
        en: 'Football',
        id: 'Sepak Bola',
      ...
      },
      {
        ...
        id: 'Medali Emas',
        emoji: '🥇',
        example: { en: 'What did you get, Andi? I got a gold medal!', id: 'Kamu dapat apa, Andi? Aku dapat medali emas!', emoji: '🥇' },
        question: {
          en: 'What prize did Andi get?',
          id: 'Hadiah apa yang Andi dapat?',
          options: [
            { emoji: '🥇', text: 'Gold Medal', ok: true },
            { emoji: '🥈', text: 'Silver Medal', ok: false },
            { emoji: '🥉', text: 'Bronze Medal', ok: false },
            { emoji: '🏆', text: 'Trophy', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Tim Merah',
        emoji: '🔴',
        example: { en: 'Which team are you in, Andi? I am in the red team.', id: 'Kamu di tim mana, Andi? Aku di tim merah.', emoji: '🔴' },
        question: {
          en: 'Which team is Andi in?',
          id: 'Andi di tim mana?',
          options: [
            { emoji: '🔴', text: 'Red Team', ok: true },
            { emoji: '🔵', text: 'Blue Team', ok: false },
            { emoji: '🟢', text: 'Green Team', ok: false },
            { emoji: '🟡', text: 'Yellow Team', ok: false },
          ],
        },
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '', text: 'Thirty', ok: true },
            { emoji: '', text: 'Thirteen', ok: false },
            { emoji: '', text: 'Twenty', ok: false },
            { emoji: '', text: 'Forty', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dia Haus',
        emoji: '💧',
        example: { en: 'Why are you drinking so much water, Andi? Because I am very thirsty.', id: 'Kenapa kamu minum banyak sekali, Andi? Karena aku haus sekali.', emoji: '💧' },
        question: {
          en: 'Why does Andi drink a lot?',
          id: 'Kenapa Andi minum banyak?',
          options: [
            { emoji: '', text: 'He Is Thirsty', ok: true },
            { emoji: '', text: 'He Is Cold', ok: false },
      ...
      },
      {
        ...
        id: 'Tarik Tambang',
        emoji: '🪢',
        example: { en: 'What game did the class play? We played tug of war.', id: 'Kelas main permainan apa? Kami main tarik tambang.', emoji: '🪢' },
        question: {
          en: 'Which game did the class play together?',
          id: 'Permainan apa yang dimainkan kelas bersama?',
          options: [
            { emoji: '', text: 'Tug of War', ok: true },
            { emoji: '', text: 'Hide and Seek', ok: false },
            { emoji: '', text: 'Chess', ok: false },
            { emoji: '', text: 'Kite Flying', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Dia Jatuh',
        emoji: '🩹',
        example: { en: 'Did you join the sack race, Andi? Yes, but I fell down.', id: 'Kamu ikut balap karung, Andi? Iya, tapi aku jatuh.', emoji: '🩹' },
        question: {
          en: 'What happened to Andi in the sack race?',
          id: 'Apa yang terjadi pada Andi di balap karung?',
          options: [
            { emoji: '', text: 'He Fell Down', ok: true },
            { emoji: '', text: 'He Won', ok: false },
            { emoji: '', text: 'He Slept', ok: false },
            { emoji: '', text: 'He Sang', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Peluit',
        emoji: '📣',
        example: { en: 'What does the coach use? She uses a whistle to start the race.', id: 'Pelatih memakai apa? Dia memakai peluit untuk memulai lomba.', emoji: '📣' },
        question: {
          en: 'What starts the race?',
          id: 'Apa yang memulai lomba?',
          options: [
            { emoji: '', text: 'A Whistle', ok: true },
            { emoji: '', text: 'A Bell', ok: false },
            { emoji: '', text: 'A Drum', ok: false },
      ...
      },
      {
        ...
        id: 'Kakaknya',
        emoji: '💪',
        example: { en: 'Who is stronger, you or your brother, Andi? My brother is stronger than me.', id: 'Siapa yang lebih kuat, kamu atau kakakmu, Andi? Kakakku lebih kuat dariku.', emoji: '💪' },
        question: {
          en: 'Who has more strength?',
          id: 'Siapa yang tenaganya lebih besar?',
          options: [
            { emoji: '', text: 'His Brother', ok: true },
            { emoji: '', text: 'His Sister', ok: false },
            { emoji: '', text: 'His Dad', ok: false },
            { emoji: '', text: 'His Friend', ok: false },
          ],
        },
      },
    ],
  },
  {
    ...
    kenalanGame: [
      ...
      },
      {
        ...
        id: 'Tadi Pagi',
        emoji: '🛏️',
        example: { en: 'Did you make your bed, Tomi? Yes, I made it this morning.', id: 'Kamu sudah merapikan tempat tidur, Tomi? Sudah, tadi pagi.', emoji: '🛏️' },
        question: {
          en: 'When did Tomi make his bed?',
          id: 'Kapan Tomi merapikan tempat tidurnya?',
          options: [
            { emoji: '🌅', text: 'This Morning', ok: true },
            { emoji: '🌙', text: 'Last Night', ok: false },
            { emoji: '☀️', text: 'At Noon', ok: false },
            { emoji: '🏫', text: 'After School', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Di Kotak Mainan',
        emoji: '📦',
        example: { en: 'Where do the toys go? Put them in the toy box.', id: 'Mainannya ditaruh di mana? Taruh di kotak mainan.', emoji: '📦' },
        question: {
          en: 'Where should the toys be?',
          id: 'Mainan seharusnya ditaruh di mana?',
          options: [
            { emoji: '', text: 'In the Toy Box', ok: true },
            { emoji: '', text: 'On the Floor', ok: false },
            { emoji: '', text: 'Under the Bed', ok: false },
            { emoji: '', text: 'In the Kitchen', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Rak yang Berdebu',
        emoji: '🤧',
        example: { en: 'Why are you sneezing, Tomi? Because the shelf is very dusty.', id: 'Kenapa kamu bersin, Tomi? Karena raknya berdebu sekali.', emoji: '🤧' },
        question: {
          en: 'What makes Tomi sneeze?',
          id: 'Apa yang membuat Tomi bersin?',
          options: [
            { emoji: '', text: 'The Dusty Shelf', ok: true },
            { emoji: '', text: 'The Cold Water', ok: false },
            { emoji: '', text: 'The Hot Soup', ok: false },
            { emoji: '', text: 'The Loud Music', ok: false },
          ],
        },
      },
      {
        en: 'After Lunch',
        id: 'Setelah Makan Siang',
        emoji: '🗑️',
        example: { en: 'Can you take out the trash, Tomi? Sure, I will do it after lunch.', id: 'Bisa buang sampahnya, Tomi? Bisa, nanti setelah makan siang.', emoji: '🗑️' },
        question: {
          en: 'When will Tomi take out the trash?',
          id: 'Kapan Tomi akan membuang sampah?',
          options: [
            { emoji: '🍱', text: 'After Lunch', ok: true },
            { emoji: '🍳', text: 'Before Breakfast', ok: false },
            { emoji: '🌙', text: 'At Midnight', ok: false },
            { emoji: '📅', text: 'Next Week', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kakaknya',
        emoji: '👕',
        example: { en: 'Who folded the clothes, Tomi? My sister folded them neatly.', id: 'Siapa yang melipat bajunya, Tomi? Kakakku melipatnya dengan rapi.', emoji: '👕' },
        question: {
          en: 'Who folded the clothes neatly?',
          id: 'Siapa yang melipat baju dengan rapi?',
          options: [
            { emoji: '', text: 'His Sister', ok: true },
            { emoji: '', text: 'His Brother', ok: false },
            { emoji: '', text: 'His Dad', ok: false },
            { emoji: '', text: 'His Mom', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Lantainya Basah',
        emoji: '🪣',
        example: { en: 'Be careful, the floor is wet. I just mopped it.', id: 'Hati-hati, lantainya basah. Aku baru saja mengepelnya.', emoji: '🪣' },
        question: {
          en: 'What is the warning about?',
          id: 'Peringatannya tentang apa?',
          options: [
            { emoji: '', text: 'The Floor Is Wet', ok: true },
            { emoji: '', text: 'The Door Is Open', ok: false },
            { emoji: '', text: 'The Light Is Off', ok: false },
            { emoji: '', text: 'The Cat Is Asleep', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Kamar Tomi',
        emoji: '🚪',
        example: { en: 'Whose room is cleaner, yours or your sister’s, Tomi? Mine is cleaner!', id: 'Kamar siapa yang lebih bersih, kamarmu atau kamar kakakmu, Tomi? Punyaku lebih bersih!', emoji: '🚪' },
        question: {
          en: 'Whose room is cleaner?',
          id: 'Kamar siapa yang lebih bersih?',
          options: [
            { emoji: '', text: 'Tomi’s Room', ok: true },
            { emoji: '', text: 'His Sister’s Room', ok: false },
            { emoji: '', text: 'Mom’s Room', ok: false },
            { emoji: '', text: 'The Guest Room', ok: false },
          ],
        },
      },
      {
        ...
        id: 'Mobil',
        emoji: '🚗',
        example: { en: 'What did Dad wash on Sunday? He washed the car.', id: 'Hari Minggu Ayah mencuci apa? Ayah mencuci mobil.', emoji: '🚗' },
        question: {
          en: 'What did Dad clean on Sunday?',
          id: 'Apa yang dibersihkan Ayah hari Minggu?',
          options: [
      ...
      },
      {
        ...
        id: 'Penyedot Debu',
        emoji: '🔌',
        example: { en: 'What is that noisy machine? It is the vacuum cleaner.', id: 'Mesin berisik apa itu? Itu penyedot debu.', emoji: '🔌' },
        question: {
          en: 'What makes the noise in the room?',
          id: 'Apa yang berbunyi berisik di ruangan?',
          options: [
            { emoji: '', text: 'Vacuum Cleaner', ok: true },
            { emoji: '', text: 'Washing Machine', ok: false },
            { emoji: '', text: 'Hair Dryer', ok: false },
            { emoji: '', text: 'Blender', ok: false },
          ],
        },
      },
    ],
...
export const LISTENING_TOPICS_LITTLE_STARS: ListeningSentenceTopic[] = [
  ...
  // Permintaan user: Little Stars belum punya topik memperkenalkan diri
  // (nama, umur, kesukaan) — "Halo & Terima Kasih" cuma sapaan. Tier Dasar
  // (`materi/pembeda_level.md`): kalimat pendek, 1 suara, practice TIDAK
  // menyebut opsi salah. Ditaruh di akhir array supaya indeks topik lama
  // tidak bergeser.
  {
    id: 'perkenalan-diri',
    title: 'Perkenalan Diri (Introducing Myself)',
    desc: '10 kalimat',
    items: [
      {
        en: 'Her Name',
        ...
        question: {
          ...
          options: [
            { emoji: '🏷️', text: 'Her Name', ok: true },
            { emoji: '🎂', text: 'Her Age', ok: false },
            { emoji: '🐱', text: 'Her Pet', ok: false },
            { emoji: '⚽', text: 'Her Toy', ok: false },
          ],
        },
      },
      ...
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '🐱', text: 'Cat', ok: true },
            { emoji: '🐶', text: 'Dog', ok: false },
            { emoji: '🐰', text: 'Rabbit', ok: false },
            { emoji: '🐸', text: 'Frog', ok: false },
          ],
        },
      },
      {
...
export const VOCAB_TOPICS_LITTLE_STARS: VocabTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Diamond', id: 'Wajik', emoji: '🔷', example: { en: 'This is a diamond.', id: 'Ini bentuk wajik.', emoji: '🔷' }, group: 'b' },
...
export const VOCAB_TOPICS_STARTER: VocabTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Burger', id: 'Burger', emoji: '🍔', example: { en: 'I want a burger for lunch.', id: 'Aku mau burger untuk makan siang.', emoji: '🍔' } },
      ...
      { en: 'Cookie', id: 'Biskuit', emoji: '🍪', example: { en: 'I eat a cookie after lunch.', id: 'Aku makan biskuit setelah makan siang.', emoji: '🍪' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Sunshine', id: 'Sinar Matahari', emoji: '☀️', example: { en: 'I play in the sunshine.', id: 'Aku bermain di bawah sinar matahari.', emoji: '☀️' } },
...
export const VOCAB_TOPICS_ACHIEVER: VocabTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Amusement Park', id: 'Taman Hiburan', emoji: '🎡', example: { en: 'We go on rides at the amusement park.', id: 'Kami naik wahana di taman hiburan.', emoji: '🎡' } },
...
export const VOCAB_TOPICS_TRAILBLAZER: VocabTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Plaster', id: 'Plester', emoji: '🩹', example: { en: 'I put a plaster on my knee.', id: 'Aku menempelkan plester di lututku.', emoji: '🩹' } },
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Hairdresser', id: 'Penata Rambut', emoji: '💇', example: { en: 'I get a haircut at the hairdresser.', id: 'Aku potong rambut di salon.', emoji: '💇' } },
    ...
    items: [
      {
        ...
        question: {
          ...
          options: [
            ...
            { emoji: '🍽️', text: 'Every Afternoon', ok: false },
          ],
        },
      },
      {
    ...
    items: [
      ...
      },
      {
        ...
        question: {
          ...
          options: [
            { emoji: '🎤', text: 'In the Choir', ok: true },
            { emoji: '🍳', text: 'In the Kitchen', ok: false },
            { emoji: '🏫', text: 'In the Classroom', ok: false },
            { emoji: '🌻', text: 'In the Garden', ok: false },
          ],
        },
      },
      {
    ...
    items: [
      {
        ...
        id: 'Tinggi',
        emoji: '📏',
        example: { en: 'Her uncle is very tall.', id: 'Pamannya sangat tinggi.', emoji: '👨' },
        practice: { en: 'Look at her uncle. He is very tall!', id: 'Lihat pamannya. Dia sangat tinggi!' },
        question: {
      ...
      },
      {
        ...
        id: 'Muda',
        emoji: '👶',
        example: { en: 'Her little cousin is young.', id: 'Sepupu kecilnya masih muda.', emoji: '🧒' },
        practice: { en: 'Her cousin is still very young.', id: 'Sepupunya masih sangat muda.' },
        question: {
      ...
      },
      {
        ...
        id: 'Rambut Keriting',
        emoji: '🧑‍🦱',
        example: { en: 'Her sister has curly hair.', id: 'Kakak perempuannya punya rambut keriting.', emoji: '👧' },
        practice: { en: "Her sister's hair is curly.", id: 'Rambut kakak perempuannya keriting.' },
        question: {
      ...
      },
      {
        ...
        id: 'Rambut Lurus',
        emoji: '💇',
        example: { en: 'Her brother has straight hair.', id: 'Kakak laki-lakinya punya rambut lurus.', emoji: '👦' },
        practice: { en: "Her brother's hair is straight.", id: 'Rambut kakak laki-lakinya lurus.' },
        question: {
    ...
    items: [
      {
        ...
        id: 'Bank',
        emoji: '🏦',
        example: { en: 'She saves her money at the bank.', id: 'Dia menabung uangnya di bank.', emoji: '🏦' },
        practice: { en: 'She keeps her savings safe at the bank.', id: 'Dia menyimpan tabungannya dengan aman di bank.' },
        question: {
      ...
      },
      {
        ...
        id: 'Kantor Pos',
        emoji: '📮',
        example: { en: 'She sends a letter at the post office.', id: 'Dia mengirim surat di kantor pos.', emoji: '✉️' },
        practice: { en: 'Her letter goes out from the post office.', id: 'Suratnya dikirim dari kantor pos.' },
        question: {
      ...
      },
      {
        ...
        id: 'Bioskop',
        emoji: '🎬',
        example: { en: 'She watches a new movie at the cinema.', id: 'Dia menonton film baru di bioskop.', emoji: '🎬' },
        practice: { en: 'There is a new film at the cinema, and she goes to see it.', id: 'Ada film baru di bioskop, dan dia pergi menontonnya.' },
        question: {
    ...
    items: [
      {
        ...
        question: {
          en: 'Which way do you turn?',
          id: 'Kamu belok ke arah mana?',
          options: [
      ...
      },
      {
        ...
        question: {
          en: 'Which way do you turn at the bank?',
          id: 'Kamu belok ke arah mana di bank?',
          options: [
      ...
      },
      {
        ...
        question: {
          en: 'How do you go past the school?',
          id: 'Bagaimana kamu melewati sekolah?',
          options: [
      ...
      },
      {
        ...
        question: {
          en: 'Is the park close by or a long way away?',
          id: 'Tamannya dekat atau jauh?',
          options: [
      ...
      },
      {
        ...
        question: {
          en: 'Is the zoo close by or a long way away?',
          id: 'Kebun binatangnya dekat atau jauh?',
          options: [
      ...
      },
      {
        ...
        id: 'Di Belakang',
        emoji: '👈',
        example: { en: 'Her house is behind the park.', id: 'Rumahnya ada di belakang taman.', emoji: '🏡' },
        practice: { en: 'Walk past the park, and you will find her house behind it.', id: 'Lewati taman, dan kamu akan menemukan rumahnya di belakangnya.' },
        question: {
    ...
    items: [
      {
        ...
        id: 'Konser',
        emoji: '🎤',
        example: { en: 'She watches a concert with her sister.', id: 'Dia menonton konser bersama kakak perempuannya.', emoji: '👧' },
        practice: { en: 'Her sister takes her to a concert.', id: 'Kakak perempuannya mengajaknya ke konser.' },
        question: {
      ...
      },
      {
        ...
        id: 'Taman Hiburan',
        emoji: '🎡',
        example: { en: 'She rides the roller coaster at the amusement park.', id: 'Dia naik roller coaster di taman hiburan.', emoji: '🎢' },
        practice: { en: 'The roller coaster is her favorite ride at the amusement park.', id: 'Roller coaster adalah wahana favoritnya di taman hiburan.' },
        question: {
      ...
      },
      {
        ...
        id: 'Catur',
        emoji: '♟️',
        example: { en: 'She plays chess with her grandpa.', id: 'Dia main catur bersama kakeknya.', emoji: '👴' },
        practice: { en: 'Her grandpa is her favorite chess partner.', id: 'Kakeknya adalah teman main catur favoritnya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Kamera',
        emoji: '📷',
        example: { en: 'She takes photos with her camera.', id: 'Dia memotret dengan kameranya.', emoji: '📷' },
        practice: { en: 'Her camera is always ready for photos.', id: 'Kameranya selalu siap untuk memotret.' },
        question: {
      ...
      },
      {
        ...
        id: 'Buku Komik',
        emoji: '🎭',
        example: { en: 'She reads a comic book before bed.', id: 'Dia membaca buku komik sebelum tidur.', emoji: '🛏️' },
        practice: { en: 'She always has a comic book to read before bed.', id: 'Dia selalu punya buku komik untuk dibaca sebelum tidur.' },
        question: {
    ...
    items: [
      {
        ...
        id: 'Memanjat',
        emoji: '🛝',
        example: { en: 'She wants to climb the tall slide.', id: 'Dia mau memanjat perosotan yang tinggi.', emoji: '🛝' },
      ...
      },
      {
        ...
        id: 'Menangkap',
        emoji: '⚽',
        example: { en: 'She tries to catch the ball her friend throws.', id: 'Dia mencoba menangkap bola yang dilempar temannya.', emoji: '⚽' },
      ...
      },
      {
        ...
        id: 'Bersembunyi',
        emoji: '🙈',
        example: { en: 'She likes to hide behind the big tree.', id: 'Dia suka bersembunyi di belakang pohon besar.', emoji: '🌳' },
      ...
      },
      {
        ...
        question: {
          ...
          id: 'Kenapa dia berteriak?',
          options: [
            { emoji: '👥', text: 'So Her Friend Will Wait', ok: true },
            { emoji: '🆘', text: 'To Ask for Help', ok: false },
            { emoji: '⚽', text: 'To Get a Ball', ok: false },
            { emoji: '🍦', text: 'To Buy Ice Cream', ok: false },
          ],
        },
      },
      {
    ...
    items: [
      {
        ...
        id: 'Komputer',
        emoji: '💻',
        example: { en: 'She uses a computer in the lab.', id: 'Dia memakai komputer di lab.', emoji: '💻' },
        practice: { en: 'The lab has a computer she can work on.', id: 'Di lab ada komputer yang bisa dia pakai.' },
        question: {
      ...
      },
      {
        ...
        id: 'Internet',
        emoji: '🌐',
        example: { en: 'She searches for information on the internet.', id: 'Dia mencari informasi di internet.', emoji: '🌐' },
      ...
      },
      {
        ...
        id: 'Surel',
        emoji: '📧',
        example: { en: 'She sends an email to her teacher.', id: 'Dia mengirim surel pada gurunya.', emoji: '🧑‍🏫' },
        practice: { en: 'Her teacher gets an email from her.', id: 'Gurunya menerima surel darinya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Kata Sandi',
        emoji: '🔑',
        example: { en: 'She types her password carefully.', id: 'Dia mengetik kata sandinya dengan hati-hati.', emoji: '🔑' },
        practice: { en: 'Her password is secret, so she types it with care.', id: 'Kata sandinya rahasia, jadi dia mengetiknya dengan hati-hati.' },
        question: {
      ...
      },
      {
        ...
        id: 'Unduh',
        emoji: '⬇️',
        example: { en: 'She wants to download a song to listen to.', id: 'Dia mau mengunduh lagu untuk didengarkan.', emoji: '🎵' },
      ...
      },
      {
        ...
        id: 'Unggah',
        emoji: '⬆️',
        example: { en: 'She needs to upload her homework file.', id: 'Dia perlu mengunggah berkas PR-nya.', emoji: '📓' },
      ...
      },
      {
        ...
        id: 'Papan Ketik',
        emoji: '⌨️',
        example: { en: 'She types fast on the keyboard.', id: 'Dia mengetik cepat di papan ketik.', emoji: '⌨️' },
      ...
      },
      {
        ...
        id: 'Tetikus',
        emoji: '🖱️',
        example: { en: 'She clicks the mouse to open the file.', id: 'Dia mengklik tetikus untuk membuka berkas.', emoji: '🖱️' },
        practice: { en: 'One click on the mouse, and the file opens.', id: 'Sekali klik tetikus, berkasnya terbuka.' },
        question: {
    ...
    items: [
      {
        ...
        id: 'Baik Hati',
        emoji: '🤗',
        example: { en: 'Her best friend is very kind.', id: 'Sahabatnya sangat baik hati.', emoji: '👥' },
        practice: { en: 'Her best friend is so kind to everyone.', id: 'Sahabatnya baik sekali pada semua orang.' },
        question: {
      ...
      },
      {
        ...
        id: 'Sabar',
        emoji: '⏳',
        example: { en: 'Her teacher is patient with the class.', id: 'Gurunya sabar menghadapi murid-murid di kelas.', emoji: '🧑‍🏫' },
        practice: { en: 'Her teacher waits for the students because she is patient.', id: 'Gurunya menunggu murid-murid karena dia sabar.' },
        question: {
      ...
      },
      {
        ...
        id: 'Sopan',
        emoji: '🙏',
        example: { en: 'She is polite and says thank you for the help.', id: 'Dia sopan dan mengucapkan terima kasih atas bantuannya.', emoji: '🙏' },
        practice: { en: 'When someone helps her, she says thank you.', id: 'Saat seseorang membantunya, dia bilang terima kasih.' },
        question: {
          en: 'What does she say when someone helps her?',
          id: 'Apa yang dia ucapkan saat ada yang membantunya?',
          options: [
            { emoji: '🙏', text: 'Thank You', ok: true },
            { emoji: '😔', text: 'Sorry', ok: false },
            { emoji: '👋', text: 'Goodbye', ok: false },
    ...
    items: [
      {
        ...
        id: 'Matematika',
        emoji: '🔢',
        example: { en: 'She solves math problems every day.', id: 'Dia menyelesaikan soal matematika setiap hari.', emoji: '🔢' },
        practice: { en: 'Every day, she works on some math problems.', id: 'Setiap hari, dia mengerjakan beberapa soal matematika.' },
        question: {
      ...
      },
      {
        ...
        id: 'Bahasa Inggris',
        emoji: '🇬🇧',
        example: { en: 'She practices speaking English every week.', id: 'Dia berlatih bicara Bahasa Inggris setiap minggu.', emoji: '🗣️' },
        practice: { en: 'Once a week, she has English speaking practice.', id: 'Seminggu sekali, dia latihan bicara Bahasa Inggris.' },
        question: {
      ...
      },
      {
        ...
        id: 'Seni',
        emoji: '🎨',
        example: { en: 'She paints a picture in art class.', id: 'Dia melukis gambar di kelas seni.', emoji: '🖼️' },
        practice: { en: 'In art class, her brush makes a nice picture.', id: 'Di kelas seni, kuasnya membuat gambar yang bagus.' },
        question: {
      ...
      },
      {
        ...
        id: 'Geografi',
        emoji: '🗺️',
        example: { en: 'She studies maps in geography class.', id: 'Dia mempelajari peta di kelas geografi.', emoji: '🗺️' },
    ...
    items: [
      {
        ...
        id: 'Tiga Puluh',
        emoji: '3️⃣0️⃣',
        example: { en: 'She has thirty stickers in her album.', id: 'Dia punya tiga puluh stiker di albumnya.', emoji: '🏷️' },
        practice: { en: 'Her sticker book holds thirty stickers.', id: 'Buku stikernya berisi tiga puluh stiker.' },
        question: {
      ...
      },
      {
        ...
        id: 'Empat Puluh',
        emoji: '4️⃣0️⃣',
        example: { en: 'She has forty marbles in her bag.', id: 'Dia punya empat puluh kelereng di tasnya.', emoji: '🔵' },
        practice: { en: 'Her bag is heavy with forty marbles inside.', id: 'Tasnya berat karena ada empat puluh kelereng di dalamnya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Lima Puluh',
        emoji: '5️⃣0️⃣',
        example: { en: 'She saves fifty coins every month.', id: 'Dia menabung lima puluh koin setiap bulan.', emoji: '🪙' },
      ...
      },
      {
        ...
        id: 'Enam Puluh',
        emoji: '6️⃣0️⃣',
        example: { en: 'She has sixty candies to share.', id: 'Dia punya enam puluh permen untuk dibagi.', emoji: '🍬' },
      ...
      },
      {
        ...
        id: 'Tujuh Puluh',
        emoji: '7️⃣0️⃣',
        example: { en: 'She read seventy pages last night.', id: 'Dia membaca tujuh puluh halaman semalam.', emoji: '📖' },
        practice: { en: 'Her book was so good that she got through seventy pages last night.', id: 'Bukunya seru sekali sampai dia membaca tujuh puluh halaman semalam.' },
        question: {
      ...
      },
      {
        ...
        id: 'Delapan Puluh',
        emoji: '8️⃣0️⃣',
        example: { en: 'She scored eighty points in the game.', id: 'Dia dapat delapan puluh poin di permainan itu.', emoji: '⭐' },
        practice: { en: 'At the end of the game, her score was eighty points.', id: 'Di akhir permainan, skornya delapan puluh poin.' },
        question: {
      ...
      },
      {
        ...
        id: 'Sembilan Puluh',
        emoji: '9️⃣0️⃣',
        example: { en: 'She collected ninety stamps this year.', id: 'Dia mengumpulkan sembilan puluh perangko tahun ini.', emoji: '📮' },
      ...
      },
      {
        ...
        id: 'Seratus',
        emoji: '💯',
        example: { en: 'She has one hundred books at home.', id: 'Dia punya seratus buku di rumah.', emoji: '📚' },
        practice: { en: 'Her room is full of books, one hundred of them!', id: 'Kamarnya penuh buku, seratus buah!' },
        question: {
  ...
  },
  {
    ...
    noteGaps: [
      ...
      },
      {
        label: 'Glitter',
        emoji: '✨',
        question: 'What kind of glitter does Made pick?',
        questionId: 'Glitter seperti apa yang dipilih Made?',
...
export const LISTENING_TOPICS_TRAILBLAZER: ListeningDialogueTopic[] = [
    ...
    items: [
      {
        ...
        id: 'Paspor',
        emoji: '🛂',
        example: { en: 'She shows her passport at the airport.', id: 'Dia menunjukkan paspornya di bandara.', emoji: '🛂' },
        practice: { en: 'When she arrives at the airport, an officer checks her passport.', id: 'Saat tiba di bandara, petugas memeriksa paspornya.' },
        question: {
          en: 'Where does she show her passport?',
          id: 'Di mana dia menunjukkan paspornya?',
          options: [
            { emoji: '✈️', text: 'The Airport', ok: true },
      ...
      },
      {
        ...
        id: 'Koper',
        emoji: '🧳',
        example: { en: 'She packs her luggage the night before.', id: 'Dia mengemas kopernya malam sebelumnya.', emoji: '🧳' },
        practice: { en: 'Her luggage is ready the night before the trip.', id: 'Kopernya sudah siap malam sebelum perjalanan.' },
        question: {
      ...
      },
      {
        ...
        id: 'Turis',
        emoji: '📸',
        example: { en: 'The tourist takes many photos.', id: 'Turis itu mengambil banyak foto.', emoji: '📸' },
      ...
      },
      {
        ...
        id: 'Oleh-oleh',
        emoji: '🎁',
        example: { en: 'She buys a souvenir for her sister.', id: 'Dia membeli oleh-oleh untuk kakak perempuannya.', emoji: '🎁' },
        practice: { en: 'Her sister gets a souvenir from the trip.', id: 'Kakak perempuannya dapat oleh-oleh dari perjalanan itu.' },
        question: {
      ...
      },
      {
        ...
        id: 'Peta',
        emoji: '🧭',
        example: { en: 'She reads the map to find the hotel.', id: 'Dia membaca peta untuk menemukan hotel.', emoji: '🧭' },
        practice: { en: 'Without the map, she cannot find the hotel.', id: 'Tanpa peta, dia tidak bisa menemukan hotelnya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Tiket',
        emoji: '🎫',
        example: { en: 'She buys a ticket online.', id: 'Dia membeli tiket secara daring.', emoji: '💻' },
        practice: { en: 'Buying the ticket online means she does not need to queue.', id: 'Membeli tiket secara daring berarti dia tidak perlu antre.' },
        question: {
    ...
    items: [
      {
        ...
        id: 'Menerjemahkan',
        emoji: '🔤',
        example: { en: 'She can translate the letter for her friend.', id: 'Dia bisa menerjemahkan surat itu untuk temannya.', emoji: '✉️' },
      ...
      },
      {
        ...
        id: 'Pengucapan',
        emoji: '👄',
        example: { en: 'She practices pronunciation every morning.', id: 'Dia berlatih pengucapan setiap pagi.', emoji: '🌅' },
      ...
      },
      {
        ...
        id: 'Kosakata',
        emoji: '📖',
        example: { en: 'She learns ten new vocabulary words a day.', id: 'Dia belajar sepuluh kosakata baru sehari.', emoji: '🔟' },
        practice: { en: 'Ten new words a day is her goal.', id: 'Sepuluh kata baru sehari adalah targetnya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Kamus',
        emoji: '📕',
        example: { en: 'She checks the dictionary for hard words.', id: 'Dia memeriksa kamus untuk kata-kata sulit.', emoji: '📕' },
      ...
      },
      {
        ...
        id: 'Dwibahasa',
        emoji: '🌍',
        example: { en: 'Her cousin is bilingual in English and Japanese.', id: 'Sepupunya dwibahasa, Inggris dan Jepang.', emoji: '🌍' },
      ...
      },
      {
        ...
        id: 'Tata Bahasa',
        emoji: '✏️',
        example: { en: 'She studies grammar before the test.', id: 'Dia belajar tata bahasa sebelum ujian.', emoji: '📝' },
        practice: { en: 'The test is soon, so she reviews her grammar first.', id: 'Ujiannya sebentar lagi, jadi dia mengulang tata bahasanya dulu.' },
        question: {
      ...
      },
      {
        ...
        id: 'Penutur Asli',
        emoji: '🎙️',
        example: { en: 'She talks to a native speaker online.', id: 'Dia bicara dengan penutur asli secara daring.', emoji: '💻' },
  ...
  {
    id: 'menelpon-jasa',
    title: 'Menelepon Jasa Reparasi (Calling a Repair Service)',
    desc: '10 kalimat + 1 percakapan',
    items: [
      {
        en: 'Receipt',
        id: 'Struk',
        emoji: '🧾',
        example: { en: 'She keeps the receipt in her wallet.', id: 'Dia menyimpan struk di dompetnya.', emoji: '👛' },
      ...
      },
      {
        ...
        emoji: '💵',
        example: { en: 'She asks for a refund because it broke.', id: 'Dia meminta pengembalian dana karena itu rusak.', emoji: '💔' },
        ...
        question: {
          ...
          options: [
            ...
            { emoji: '🎨', text: 'It Was the Wrong Color', ok: false },
      ...
      },
      {
        ...
        id: 'Permintaan',
        emoji: '🙋',
        example: { en: 'She makes a request for a later time.', id: 'Dia mengajukan permintaan untuk waktu yang lebih siang.', emoji: '🕒' },
    ...
    dialogueHeading: 'Menelepon Jasa Reparasi',
    dialogueLines: [
    ...
    inferenceQuestions: [
      ...
      },
      {
        ...
        options: [
          ...
          { emoji: '🌅', text: 'This Morning', ok: false },
          { emoji: '🗓️', text: 'Next Week', ok: false },
    ...
    items: [
      {
        ...
        id: 'Menukar',
        emoji: '🔁',
        example: { en: 'She wants to exchange this shirt for a bigger size.', id: 'Dia mau menukar kemeja ini dengan ukuran lebih besar.', emoji: '👕' },
      ...
      },
      {
        ...
        id: 'Diskon',
        emoji: '🏷️',
        example: { en: 'She gets a discount because of the sale.', id: 'Dia dapat potongan harga karena ada obral.', emoji: '🎉' },
      ...
      },
      {
        ...
        id: 'Ruang Pas',
        emoji: '🚪',
        example: { en: 'She tries on the dress in the fitting room.', id: 'Dia mencoba gaun itu di ruang pas.', emoji: '👗' },
      ...
      },
      {
        ...
        id: 'Barang Murah',
        emoji: '💰',
        example: { en: 'She found a great bargain at the market.', id: 'Dia menemukan barang murah yang bagus di pasar.', emoji: '🛒' },
        practice: { en: 'What a bargain! She got it cheap at the market.', id: 'Murah sekali! Dia membelinya dengan harga murah di pasar.' },
        question: {
      ...
      },
      {
        ...
        id: 'Label Harga',
        emoji: '🏷️',
        example: { en: 'She checks the price tag before she buys it.', id: 'Dia memeriksa label harga sebelum membelinya.', emoji: '🏷️' },
      ...
      },
      {
        ...
        id: 'Mengembalikan',
        emoji: '↩️',
        example: { en: "She has to return the shoes because they don't fit.", id: 'Dia harus mengembalikan sepatu itu karena tidak pas.', emoji: '📦' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        id: 'PR',
        emoji: '📔',
        example: { en: 'She tries to finish her homework before dinner.', id: 'Dia berusaha menyelesaikan PR-nya sebelum makan malam.', emoji: '🍽️' },
      ...
      },
      {
        ...
        id: 'Buku Pelajaran',
        emoji: '📚',
        example: { en: 'She borrows a textbook from the library.', id: 'Dia meminjam buku pelajaran dari perpustakaan.', emoji: '📚' },
        practice: { en: 'The library lends her a textbook.', id: 'Perpustakaan meminjamkan buku pelajaran padanya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Teman Sekelas',
        emoji: '🧑‍🎓',
        example: { en: 'Her classmate helps her with math.', id: 'Teman sekelasnya membantunya belajar matematika.', emoji: '🔢' },
      ...
      },
      {
        ...
        id: 'Tugas',
        emoji: '📄',
        example: { en: 'She submits her assignment online.', id: 'Dia mengirim tugasnya secara daring.', emoji: '💻' },
      ...
      },
      {
        ...
        id: 'Rapor',
        emoji: '📋',
        example: { en: 'She shows her report card to her parents.', id: 'Dia menunjukkan rapornya pada orang tuanya.', emoji: '👨‍👩‍👧' },
        practice: { en: 'Her parents see her report card when she gets home.', id: 'Orang tuanya melihat rapornya saat dia sampai di rumah.' },
        question: {
      ...
      },
      {
        ...
        id: 'Belajar',
        emoji: '📖',
        example: { en: 'She likes to study with her friends at the library.', id: 'Dia suka belajar dengan teman-temannya di perpustakaan.', emoji: '👥' },
    ...
    items: [
      {
        ...
        id: 'Genre',
        emoji: '🎬',
        example: { en: 'She likes the action genre the most.', id: 'Dia paling suka genre aksi.', emoji: '💥' },
      ...
      },
      {
        ...
        id: 'Cuplikan Film',
        emoji: '🎞️',
        example: { en: 'She watches the trailer before buying a ticket.', id: 'Dia menonton cuplikan filmnya sebelum membeli tiket.', emoji: '🎫' },
        practice: { en: 'She never buys a ticket without watching the trailer first.', id: 'Dia tidak pernah membeli tiket tanpa menonton cuplikannya dulu.' },
        question: {
      ...
      },
      {
        ...
        id: 'Subtitel',
        emoji: '💬',
        example: { en: 'She reads the subtitles because the movie is in French.', id: 'Dia membaca subtitel karena filmnya berbahasa Prancis.', emoji: '🇫🇷' },
        practice: { en: 'The movie is in French, so she reads the subtitles.', id: 'Filmnya berbahasa Prancis, jadi dia membaca subtitelnya.' },
        question: {
          en: 'Why does she read the subtitles?',
      ...
      },
      {
        ...
        emoji: '📺',
        example: { en: 'She watches movies on a streaming app.', id: 'Dia menonton film di aplikasi streaming.', emoji: '📱' },
        practice: { en: 'A streaming app is where she finds her movies.', id: 'Aplikasi streaming adalah tempat dia mencari film.' },
        question: {
      ...
      },
      {
        ...
        id: 'Episode',
        emoji: '📀',
        example: { en: 'She watches one episode every night.', id: 'Dia menonton satu episode setiap malam.', emoji: '🌙' },
        practice: { en: 'Only one episode a night, that is her rule.', id: 'Cuma satu episode semalam, itu aturannya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Ulasan',
        emoji: '⭐',
        example: { en: 'She reads the review before choosing a movie.', id: 'Dia membaca ulasan sebelum memilih film.', emoji: '📝' },
        practice: { en: 'Before she chooses a movie, she wants to know what the review says.', id: 'Sebelum memilih film, dia ingin tahu isi ulasannya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Aktor',
        emoji: '🧑‍🎤',
        example: { en: 'Her favorite actor is in the new movie.', id: 'Aktor favoritnya ada di film baru itu.', emoji: '⭐' },
      ...
      },
      {
        ...
        id: 'Musik Latar',
        emoji: '🎵',
        example: { en: 'She loves the soundtrack of that film.', id: 'Dia suka musik latar film itu.', emoji: '🎧' },
      ...
      },
      {
        ...
        emoji: '🎥',
        example: { en: 'They go to the movie premiere together.', id: 'Mereka pergi ke pemutaran perdana film itu bersama.', emoji: '👥' },
    ...
    items: [
      {
        ...
        id: 'Pendapat',
        emoji: '💭',
        example: { en: 'She shares her opinion about the book.', id: 'Dia berbagi pendapatnya tentang buku itu.', emoji: '📖' },
      ...
      },
      {
        ...
        id: 'Setuju',
        emoji: '👍',
        example: { en: 'She and her mom agree about the ending.', id: 'Dia dan ibunya sependapat soal akhir ceritanya.', emoji: '🏁' },
      ...
      },
      {
        ...
        id: 'Tidak Setuju',
        emoji: '👎',
        example: { en: 'She and her dad disagree with the negative review.', id: 'Dia dan ayahnya tidak setuju dengan ulasan negatif itu.', emoji: '⭐' },
      ...
      },
      {
        ...
        id: 'Merekomendasikan',
        emoji: '👉',
        example: { en: 'She wants to recommend this book to her friend.', id: 'Dia mau merekomendasikan buku ini pada temannya.', emoji: '👥' },
      ...
      },
      {
        ...
        id: 'Terkesan',
        emoji: '😍',
        example: { en: 'She is impressed by the ending.', id: 'Dia terkesan dengan akhir ceritanya.', emoji: '🏆' },
      ...
      },
      {
        ...
        id: 'Kecewa',
        emoji: '😞',
        example: { en: 'She is disappointed by the slow start.', id: 'Dia kecewa dengan awal cerita yang lambat.', emoji: '⏳' },
      ...
      },
      {
        ...
        id: 'Penasaran',
        emoji: '🤔',
        example: { en: 'She is curious about the next chapter.', id: 'Dia penasaran dengan bab selanjutnya.', emoji: '❓' },
      ...
      },
      {
        ...
        id: 'Favorit',
        emoji: '❤️',
        example: { en: 'This is her favorite book this year.', id: 'Ini buku favoritnya tahun ini.', emoji: '❤️' },
      ...
      },
      {
        ...
        id: 'Menarik',
        emoji: '✨',
        example: { en: 'She finds the characters very interesting.', id: 'Dia merasa tokoh-tokohnya sangat menarik.', emoji: '🎭' },
    ...
    items: [
      {
        ...
        emoji: '🏘️',
        example: { en: 'She lives in a quiet neighborhood.', id: 'Dia tinggal di lingkungan yang tenang.', emoji: '🤫' },
      ...
      },
      {
        ...
        id: 'Petunjuk Arah',
        emoji: '🧭',
        example: { en: 'She asks for directions to the café.', id: 'Dia meminta petunjuk arah ke kafe itu.', emoji: '🙋' },
        practice: { en: 'Which way is the café? She needs directions.', id: 'Kafenya ke arah mana? Dia butuh petunjuk arah.' },
        question: {
      ...
      },
      {
        ...
        id: 'Trotoar',
        emoji: '👣',
        example: { en: 'They walk along the sidewalk to the café.', id: 'Mereka berjalan di sepanjang trotoar menuju kafe.', emoji: '👣' },
      ...
      },
      {
        ...
        id: 'Papan Penunjuk',
        emoji: '🪧',
        example: { en: 'She looks for a signpost with the café name.', id: 'Dia mencari papan penunjuk dengan nama kafenya.', emoji: '🔎' },
    ...
    items: [
      {
        ...
        id: 'Daur Ulang',
        emoji: '♻️',
        example: { en: 'They recycle plastic bottles every week.', id: 'Mereka mendaur ulang botol plastik setiap minggu.', emoji: '📅' },
      ...
      },
      {
        ...
        id: 'Lingkungan',
        emoji: '🌍',
        example: { en: 'They protect the environment together.', id: 'Mereka menjaga lingkungan bersama-sama.', emoji: '🌍' },
      ...
      },
      {
        ...
        id: 'Plastik',
        emoji: '🧴',
        example: { en: 'She avoids using plastic bags.', id: 'Dia menghindari pemakaian kantong plastik.', emoji: '🛍️' },
      ...
      },
      {
        ...
        id: 'Kompos',
        emoji: '🍂',
        example: { en: 'They compost their food waste.', id: 'Mereka mengomposkan sisa makanan mereka.', emoji: '🍽️' },
      ...
      },
      {
        ...
        emoji: '🔄',
        example: { en: 'She brings a reusable water bottle.', id: 'Dia membawa botol minum yang bisa dipakai ulang.', emoji: '🚰' },
      ...
      },
      {
        ...
        id: 'Terbarukan',
        emoji: '☀️',
        example: { en: 'They use renewable energy at home.', id: 'Mereka memakai energi terbarukan di rumah.', emoji: '🏠' },
    ...
    items: [
      {
        ...
        id: 'Wawancara',
        emoji: '🎙️',
        example: { en: 'She has a job interview tomorrow.', id: 'Dia ada wawancara kerja besok.', emoji: '📅' },
      ...
      },
      {
        ...
        id: 'Resume',
        emoji: '📄',
        example: { en: 'She updates her resume before applying.', id: 'Dia memperbarui resumenya sebelum melamar.', emoji: '✏️' },
        practice: { en: 'Before she applies for a job, her resume gets updated.', id: 'Sebelum melamar kerja, resumenya diperbarui dulu.' },
        question: {
      ...
      },
      {
        ...
        id: 'Keahlian',
        emoji: '💡',
        example: { en: 'She lists her computer skill on the form.', id: 'Dia mencantumkan keahlian komputernya di formulir.', emoji: '💻' },
        practice: { en: 'Her computer skill goes on the form.', id: 'Keahlian komputernya dicantumkan di formulir.' },
        question: {
      ...
      },
      {
        ...
        id: 'Pengalaman',
        emoji: '📈',
        example: { en: 'She has two years of experience.', id: 'Dia punya pengalaman dua tahun.', emoji: '2️⃣' },
      ...
      },
      {
        ...
        id: 'Atasan',
        emoji: '🧑‍💼',
        example: { en: 'Her employer is very kind.', id: 'Atasannya sangat baik hati.', emoji: '🤗' },
        practice: { en: 'She works for a very kind employer.', id: 'Dia bekerja untuk atasan yang sangat baik hati.' },
        question: {
      ...
      },
      {
        ...
        id: 'Gaji',
        emoji: '💰',
        example: { en: 'They discuss the salary at the end.', id: 'Mereka membahas gaji di akhir.', emoji: '🏁' },
      ...
      },
      {
        ...
        id: 'Karier',
        emoji: '🚀',
        example: { en: 'She wants a career in design.', id: 'Dia ingin berkarier di bidang desain.', emoji: '🎨' },
        practice: { en: 'Design is the career she dreams of.', id: 'Desain adalah karier yang dia impikan.' },
        question: {
      ...
      },
      {
        ...
        id: 'Kualifikasi',
        emoji: '🎓',
        example: { en: 'She has the right qualification for this job.', id: 'Dia punya kualifikasi yang tepat untuk pekerjaan ini.', emoji: '✅' },
      ...
      },
      {
        ...
        id: 'Rekan Kerja',
        emoji: '👥',
        example: { en: 'Her colleague helps her with the project.', id: 'Rekan kerjanya membantunya dengan proyek itu.', emoji: '📋' },
        practice: { en: 'On the project, her colleague gives her a lot of help.', id: 'Di proyek itu, rekan kerjanya banyak membantunya.' },
        question: {
      ...
      },
      {
        ...
        id: 'Posisi',
        emoji: '📋',
        example: { en: 'She applies for a new position at the company.', id: 'Dia melamar posisi baru di perusahaan itu.', emoji: '🏢' },
...
export const SPEAKING_TOPICS_LITTLE_STARS: SpeakingPhraseTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Socks', id: 'Kaus Kaki', emoji: '🧦', phrase: { en: 'I wear warm socks.', id: 'Aku memakai kaus kaki hangat.', emoji: '🧦' } },
...
export const SPEAKING_TOPICS_STARTER: SpeakingPhraseTopic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { en: 'Saturday', id: 'Sabtu', emoji: '🎉', phrase: { en: 'There is no school on Saturday.', id: 'Tidak ada sekolah hari Sabtu.', emoji: '🎉' } },
